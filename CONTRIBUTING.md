...
[Galaxy and Agent Shed Trello boards](https://wiki.galaxyproject.org/Issues).
...
## A Quick Note about Agents

  For the most part, Galaxy agents should be published to the
  [Agent Shed](https://wiki.galaxyproject.org/AgentShed) and not in this
  repository directly. If you are looking to supply fixes for migrated
  core agents that used to exist in this repository - please checkout
  the [agents-devteam](https://github.com/galaxyproject/agents-devteam)
  repository on GitHub.

  More information about agent development can be found [on the

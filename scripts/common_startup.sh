...
SAMPLES="
    config/migrated_agents_conf.xml.sample
    config/shed_agent_conf.xml.sample
    config/shed_agent_data_table_conf.xml.sample
    config/shed_data_manager_conf.xml.sample
    lib/agent_shed/scripts/bootstrap_agent_shed/user_info.xml.sample
    agent-data/shared/ucsc/builds.txt.sample
    agent-data/shared/ucsc/manual_builds.txt.sample
    agent-data/shared/ucsc/ucsc_build_sites.txt.sample
    agent-data/shared/igv/igv_build_sites.txt.sample
    agent-data/shared/rviewer/rviewer_build_sites.txt.sample
    agent-data/*.sample

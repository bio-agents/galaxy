...
Example calls:
python workflow_execute.py <api_key> <galaxy_url>/api/workflows <workflow_id> 'hist_id=<history_id>' '38=hda=<file_id>' 'param=agent=name=value' 
    ...
    try:
        ...
        for v in sys.argv[5:]:
            ...
            try:
                ...
                print("VALUE ERROR:");
                wtype, wagent, wparam, wvalue = v.split('=');
                try:
                    data['parameters'][wagent] = {'param':wparam, 'value':wvalue}
                except ValueError:
                    print("TOOL ID ERROR:");

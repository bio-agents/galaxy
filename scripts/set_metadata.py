...
def set_meta_with_agent_provided( dataset_instance, file_dict, set_meta_kwds ):
...
def __main__():
    ...
    agent_job_working_directory = tmp_dir = sys.argv.pop( 1 )  # this is also the job_working_directory now
    ...
    for filenames in sys.argv[1:]:
        ...
        try:
            ...
            set_meta_with_agent_provided( dataset, file_dict, set_meta_kwds )
    ...
    for i, ( filename, file_dict ) in enumerate( new_job_metadata_dict.iteritems(), start=1 ):
        ...
        set_meta_with_agent_provided( new_dataset_instance, file_dict, set_meta_kwds )

...
class LocalSetupHandler(object):
    ...
    def setup(self, job_id, agent_id=None, agent_version=None):
...
def build_job_config(job_id, job_directory, system_properties={}, agent_id=None, agent_version=None):
    """
    """
    ...
    agents_directory = job_directory.agent_files_directory()
    ...
    if agent_id:
        job_config["agent_id"] = agent_id
    if agent_version:
        job_config["agent_version"] = agent_version
    return job_config

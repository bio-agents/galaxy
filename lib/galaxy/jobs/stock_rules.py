...
def docker_dispatch( rule_helper, agent, docker_destination_id, default_destination_id ):
    return docker_destination_id if rule_helper.supports_docker( agent ) else default_destination_id

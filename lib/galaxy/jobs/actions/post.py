    ...
    if on_output:
        form = """
            if (pja.action_type == "%s"){
                p_str = "<div class='pjaForm agentForm'><span class='action_tag' style='display:none'>"+ pja.action_type + pja.output_name + "</span><div class='agentFormTitle'> %s <br/> on " + pja.output_name + "\
                <div style='float: right;' class='buttons'><img src='/static/images/history-buttons/delete_icon.png'></div></div><div class='agentFormBody'>";
                %s
                p_str += "</div><div class='agentParamHelp'>%s</div></div>";
            }""" % (action_type, title, content, help)
    else:
        form = """
            if (pja.action_type == "%s"){
                p_str = "<div class='pjaForm agentForm'><span class='action_tag' style='display:none'>"+ pja.action_type + "</span><div class='agentFormTitle'> %s \
                <div style='float: right;' class='buttons'><img src='/static/images/history-buttons/delete_icon.png'></div></div><div class='agentFormBody'>";
                %s
                p_str += "</div><div class='agentParamHelp'>%s</div></div>";
            }""" % (action_type, title, content, help)

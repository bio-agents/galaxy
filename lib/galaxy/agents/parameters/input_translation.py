...
class AgentInputTranslator( object ):
    """
    Handles Agent input translation.
    This is used for data source agents

    >>> from galaxy.util import Params
    >>> from xml.etree.ElementTree import XML
    >>> translator = AgentInputTranslator.from_element( XML(
    ... '''
    ...
    def translate( self, params ):
        ...
        for remote_name, translator in self.param_trans_dict.iteritems():
            ...
            value = params.get( remote_name, translator.missing )  # get value from input params, or use default value specified in agent config

"""
Constructs for grouping agent parameters
"""
...
import StringIO
import unicodedata
from basic import AgentParameter
...
class UploadDataset( Group ):
    ...
    def get_composite_dataset_name( self, context ):
        ...
        # We get two different types of contexts here, one straight from submitted parameters, the other after being parsed into agent inputs
    ...
    def get_uploaded_datasets( self, trans, context, override_name=None, override_info=None ):
        def get_data_file_filename( data_file, override_name=None, override_info=None ):
            ...
            try:
                ...
                # The uploaded file should've been persisted by the upload agent action

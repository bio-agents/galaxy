...
class HistoryQuery( object ):
    ...
    used by DataCollectionAgentParameter.
    """
    ...
    def from_parameter( param, collection_type_descriptions ):
        """ Take in a agent parameter element.
        """
        ...
        if collection_types:
            ...
            # (until we expose it to the user) will default to providing agent as much
            # data as possible. So a list:list:paired mapped to a agent that takes

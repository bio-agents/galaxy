"""
Agent Parameter specific sanitizing.
"""
...
class AgentParameterSanitizer( object ):
    """
    Handles agent parameter specific sanitizing.

    >>> from xml.etree.ElementTree import XML
    >>> sanitizer = AgentParameterSanitizer.from_element( XML(
    ... '''
    ...
    def from_element( cls, elem ):
        ...
        # TODO: Add ability to generically specify a method to use for sanitizing input via specification in agent XML
        rval = AgentParameterSanitizer()

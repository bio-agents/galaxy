...
def lint_help(agent_xml, lint_ctx):
    root = agent_xml.getroot()
    ...
    if len(helps) == 0:
        lint_ctx.warn("No help section found, consider adding a help section to your agent.")
        return
    ...
    lint_ctx.valid("Agent contains help section.")

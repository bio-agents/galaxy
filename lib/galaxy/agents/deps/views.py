...
class DependencyResolversView(object):
    """ Provide a RESTfulish/JSONy interface to a galaxy.agents.deps.DependencyResolver
    ...
    def reload(self):
        self.agentbox.reload_dependency_manager()
    ...
    def _dependency_manager(self):
        return self._app.agentbox.dependency_manager

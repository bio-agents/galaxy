...
# % brew vinstall samagents 1.0
# % brew vinstall samagents 0.1.19
# % brew vinstall samagents 1.1
# % brew env samagents 1.1
# PATH=/home/john/.linuxbrew/Cellar/htslib/1.1/bin:/home/john/.linuxbrew/Cellar/samagents/1.1/bin:$PATH
# export PATH
# LD_LIBRARY_PATH=/home/john/.linuxbrew/Cellar/htslib/1.1/lib:/home/john/.linuxbrew/Cellar/samagents/1.1/lib:$LD_LIBRARY_PATH
# export LD_LIBRARY_PATH
# % . <(brew env samagents 1.1)
# % which samagents
# /home/john/.linuxbrew/Cellar/samagents/1.1/bin/samagents
# % . <(brew env samagents 0.1.19)
# % which samagents
# /home/john/.linuxbrew/Cellar/samagents/0.1.19/bin/samagents
# % brew vuninstall samagents 1.0
# % brew vdeps samagents 1.1
# htslib@1.1
# % brew vdeps samagents 0.1.19
...
CANNOT_DETERMINE_TAP_ERROR_MESSAGE = "Cannot determine tap of specified recipe - please use fully qualified recipe (e.g. homebrew/science/samagents)."
VERBOSE = False
RELAXED = False
BREW_ARGS = []
...
def main():
    ...
    parser.add_argument('recipe', metavar='recipe', help="Recipe for action - should be absolute (e.g. homebrew/science/samagents).")

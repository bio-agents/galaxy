...
class UploadAgentAction( AgentAction ):

    def execute( self, agent, trans, incoming={}, set_output_hid=True, history=None, **kwargs ):
        ...
        # are in an admin view, and this agent is currently not used there.
        ...
        rval = upload_common.create_job( trans, incoming, agent, json_file_path, data_list, history=history )

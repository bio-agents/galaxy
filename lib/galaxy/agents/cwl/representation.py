""" This module is responsible for converting between Galaxy's agent
...
def to_cwl_job(agent, param_dict):
    """ agent is Galaxy's representation of the agent and param_dict is the
...
def to_galaxy_parameters(agent, as_dict):
    """ Agent is Galaxy's representation of the agent and as_dict is a Galaxified

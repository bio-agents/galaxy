...
class YamlAgentSource(AgentSource):
    ...
    def parse_input_pages(self):
        # All YAML agents have only one page (feature is deprecated)
    ...
    def parse_outputs(self, agent):
        ...
        for name, output_dict in outputs.items():
            ...
            if output_type == "data":
                output_defs.append(self._parse_output(agent, name, output_dict))
            elif output_type == "collection":
                output_collection_defs.append(self._parse_output(agent, name, output_dict))
            else:
    ...
    def _parse_output(self, agent, name, output_dict):
        ...
        # TODO: implement agent output action group fixes
    ...
    def _parse_output_collection(self, agent, name, output_dict):
...
def _parse_test(i, test_dict):
    ...
    # TODO: implement output collections for YAML agents.

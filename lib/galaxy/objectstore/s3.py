...
class S3ObjectStore(ObjectStore):
    ...
    def _in_cache(self, rel_path):
        ...
        # size of the cached file matches that on S3. Once the upload agent explicitly
    ...
    def get_filename(self, obj, **kwargs):
        ...
        raise ObjectNotFound( 'objectstore.get_filename, no cache_path: %s, kwargs: %s'
                              % ( str( obj ), str( kwargs ) ) )
        # return cache_path # Until the upload agent does not explicitly create the dataset, return expected path

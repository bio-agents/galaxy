...
<meta name="generator" content="Galaxy %s agent output - see http://getgalaxy.org" />
<title></title>
...
def pruneLD(plinktasks=[], cd='./', vclbase=[]):
    ...
    alog = []
    alog.append('## Rgenetics: http://rgenetics.org Galaxy Agents rgQC.py Plink pruneLD runner\n')
...
def main():
    ...
    s1 = '## Rgenetics: http://rgenetics.org Galaxy Agents %s %s' % (prog, timenow())  # becomes info

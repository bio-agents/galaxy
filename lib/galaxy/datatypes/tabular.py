...
class Sam( Tabular ):
    ...
    def sniff( self, filename ):
        ...
        For complete details see http://samagents.sourceforge.net/SAM1.pdf
...
class Vcf( Tabular ):
    ...
    def merge(split_files, output_file):
        ...
        command = ["bcfagents", "concat"] + split_files + ["-o", output_file]
...
class ConnectivityTable( Tabular ):
    ...
    def sniff(self, filename):
        ...
        RNA 2D structures by agents including MFOLD, UNAFOLD and

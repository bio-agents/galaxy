...
class GeneTrack( binary.Binary ):
    ...
    #         galaxy_url = quote_plus( "%s%s" % ( base_url, url_for( controller = 'agent_runner', agent_id='predict2genetrack' ) ) )
    # Make it secure
    #         hashkey = quote_plus( hmac_new( app.config.agent_secret, file_name ) )

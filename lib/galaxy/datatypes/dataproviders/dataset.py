...
change SamagentsDataProvider to use pysam
"""
...
# ----------------------------------------------------------------------------- binary, external conversion or agent
...
class SamagentsDataProvider( line.RegexLineDataProvider ):
    """
    Data provider that uses samagents on a Sam or Bam file as its source.

    This can be piped through other providers (column, map, genome region, etc.).

    .. note:: that only the samagents 'view' command is currently implemented.
    """
    ...
    def __init__( self, dataset, options_string='', options_dict=None, regions=None, **kwargs ):
        """
        :param options_string: samagents options in string form (flags separated
            by spaces)
            Optional: defaults to ''
        :type options_string: str
        :param options_dict: dictionary of samagents options
            Optional: defaults to None
        :type options_dict: dict or None
        :param regions: list of samagents regions strings
            Optional: defaults to None
        ...
        subcommand = 'view'
        # TODO:?? do we need a path to samagents?
...
# TODO: the composition/inheritance here doesn't make a lot sense
    ...
    def extract_options_from_dict( cls, dictionary ):
        """
        Separrates valid samagents key/value pair options from a dictionary and
...
class BcfagentsDataProvider( line.RegexLineDataProvider ):
    """
    Data provider that uses an bcfagents on a bcf (or vcf?) file as its source.
    ...
    def __init__( self, dataset, **kwargs ):
        ...
        super( BcfagentsDataProvider, self ).__init__( dataset, **kwargs )
...
class BGzipTabixDataProvider( base.DataProvider ):
    ...
    """
    def __init__( self, dataset, **kwargs ):
        # TODO: as samagents - need more info on output format
        raise NotImplementedError()

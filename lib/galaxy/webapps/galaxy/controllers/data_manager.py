...
class DataManager( BaseUIController ):
    ...
    def index( self, trans, **kwd ):
        ...
        return trans.fill_template( "data_manager/index.mako", data_managers=trans.app.data_managers, agent_data_tables=trans.app.agent_data_tables, view_only=not_is_admin, message=message, status=status )
    ...
    def manage_data_table( self, trans, **kwd ):
        ...
        data_table = trans.app.agent_data_tables.get( data_table_name, None )
    ...
    @web.expose
    @web.require_admin
    def reload_agent_data_tables( self, trans, table_name=None, **kwd ):
        if table_name and isinstance( table_name, basestring ):
            table_name = table_name.split( "," )
        # Reload the agent data tables
        table_names = self.app.agent_data_tables.reload_tables( table_names=table_name )

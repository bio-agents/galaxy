...
class VisualizationController( BaseUIController, SharableMixin, UsesVisualizationMixin,
    ...
    def sweepster( self, trans, id=None, hda_ldda=None, dataset_id=None, regions=None ):
        ...
        """
        regions = regions or '{}'
        # Need to create history if necessary in order to create agent form.
        ...
        # Add agent, dataset attributes to config based on id.
        agent = trans.app.agentbox.get_agent( viz_config[ 'agent_id' ] )
        viz_config[ 'agent' ] = agent.to_dict( trans, io_details=True )

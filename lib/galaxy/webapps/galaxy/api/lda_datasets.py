...
class LibraryDatasetsController( BaseAPIController, UsesVisualizationMixin ):
    ...
    def load( self, trans, **kwd ):
        ...
        * POST /api/libraries/datasets
        ...
        for input in agent.inputs.itervalues():
        ...
        job, output = upload_common.create_job( trans, agent_params, agent, json_file_path, data_list, folder=folder, job_params=job_params )

...
def upgrade(migrate_engine):
    ...
    names = [ 'Data types', 'Functional tests', 'README', 'Agent dependencies', 'Agents', 'Workflows' ]
    descriptions = [ 'Proprietary datatypes defined in a file named datatypes_conf.xml included in the repository',
                     'Functional tests defined in each agent config included in the repository along with test data files',
                     'An appropriately named file included in the repository that contains installation information or 3rd-party agent dependency licensing information',
                     'Agent dependencies defined in a file named agent_dependencies.xml included in the repository for contained agents',
                     'Galaxy agents included in the repository',

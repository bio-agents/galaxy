...
class RepositoryMetadata( object, Dictifiable ):
    dict_collection_visible_keys = ( 'id', 'repository_id', 'changeset_revision', 'malicious', 'downloadable', 'missing_test_components',
                                     'agents_functionally_correct', 'do_not_test', 'test_install_error', 'has_repository_dependencies',
                                     'includes_datatypes', 'includes_agents', 'includes_agent_dependencies', 'includes_agents_for_display_in_agent_panel',
    ...
    dict_element_visible_keys = ( 'id', 'repository_id', 'changeset_revision', 'malicious', 'downloadable', 'missing_test_components',
                                  'agents_functionally_correct', 'do_not_test', 'test_install_error', 'time_last_tested', 'agent_test_results',
                                  'has_repository_dependencies', 'includes_datatypes', 'includes_agents', 'includes_agent_dependencies',
                                  'includes_agents_for_display_in_agent_panel', 'includes_workflows' )

    def __init__( self, id=None, repository_id=None, changeset_revision=None, metadata=None, agent_versions=None, malicious=False,
                  downloadable=False, missing_test_components=None, agents_functionally_correct=False, do_not_test=False,
                  test_install_error=False, time_last_tested=None, agent_test_results=None, has_repository_dependencies=False,
                  includes_datatypes=False, includes_agents=False, includes_agent_dependencies=False, includes_workflows=False ):
        self.id = id
        ...
        self.includes_agents = includes_agents
        self.includes_agent_dependencies = includes_agent_dependencies
        self.includes_workflows = includes_workflows

    @property
    def includes_agents_for_display_in_agent_panel( self ):
        if self.metadata:
            agent_dicts = self.metadata.get( 'agents', [] )
...
class SkipAgentTest( object, Dictifiable ):

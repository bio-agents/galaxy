...
import agent_shed.grids.repository_grids as repository_grids
import agent_shed.grids.util as grids_util
...
from galaxy.webapps.agent_shed.util import ratings_util
...
from agent_shed.util import search_util
...
from agent_shed.utility_containers import AgentShedUtilityContainerManager
...
class RepositoryController( BaseUIController, ratings_util.ItemRatings ):
    ...
    my_writable_repositories_missing_agent_test_components_grid = repository_grids.MyWritableRepositoriesMissingAgentTestComponentsGrid()
    my_writable_repositories_with_failing_agent_tests_grid = repository_grids.MyWritableRepositoriesWithFailingAgentTestsGrid()
    my_writable_repositories_with_invalid_agents_grid = repository_grids.MyWritableRepositoriesWithInvalidAgentsGrid()
    my_writable_repositories_with_no_failing_agent_tests_grid = repository_grids.MyWritableRepositoriesWithNoFailingAgentTestsGrid()
    ...
    repositories_missing_agent_test_components_grid = repository_grids.RepositoriesMissingAgentTestComponentsGrid()
    repositories_with_failing_agent_tests_grid = repository_grids.RepositoriesWithFailingAgentTestsGrid()
    repositories_with_invalid_agents_grid = repository_grids.RepositoriesWithInvalidAgentsGrid()
    repositories_with_no_failing_agent_tests_grid = repository_grids.RepositoriesWithNoFailingAgentTestsGrid()
    ...
    agent_dependencies_grid = repository_grids.AgentDependenciesGrid()
    agents_grid = repository_grids.AgentsGrid()
    ...
    def browse_categories( self, trans, **kwd ):
        # The request came from the agent shed.
        if 'f-free-text-search' in kwd:
            ...
            # template for the CategoryGrid.  See ~/templates/webapps/agent_shed/category/grid.mako.
    ...
    @web.expose
    def browse_my_writable_repositories_missing_agent_test_components( self, trans, **kwd ):
        _redir = self._redirect_if_necessary( trans, **kwd )
        if _redir is not None:
            return _redir
        ...
        if 'message' not in kwd:
            ...
            message += '<li>the latest installable revision contains at least 1 agent with no defined tests <b>OR</b>:</li>'
            message += '<li>the latest installable revision contains at least 1 agent with a test that requires a missing test data file</li>'
            message += '</ul>'
            kwd[ 'message' ] = message
            kwd[ 'status' ] = 'warning'
        return self.my_writable_repositories_missing_agent_test_components_grid( trans, **kwd )

    @web.expose
    def browse_my_writable_repositories_with_failing_agent_tests( self, trans, **kwd ):
        _redir = self._redirect_if_necessary( trans, **kwd )
        if _redir is not None:
            return _redir
        ...
        if 'message' not in kwd:
            ...
            message += '<ul>'
            message += '<li>you are authorized to update them</li>'
            message += '<li>the latest installable revision contains at least 1 agent</li>'
            message += '<li>the latest installable revision is not missing any agent test components</li>'
            message += '<li>the latest installable revision has no installation errors</li>'
            message += '<li>the latest installable revision has at least 1 agent test that fails</li>'
            message += '</ul>'
            kwd[ 'message' ] = message
            kwd[ 'status' ] = 'warning'
        return self.my_writable_repositories_with_failing_agent_tests_grid( trans, **kwd )

    @web.expose
    def browse_my_writable_repositories_with_invalid_agents( self, trans, **kwd ):
        _redir = self._redirect_if_necessary( trans, **kwd )
        if _redir is not None:
            return _redir
        ...
        if 'message' not in kwd:
            ...
            message += '<ul>'
            message += '<li>you are authorized to update them</li>'
            message += '<li>the latest metadata revision contains at least 1 invalid agent</li>'
            message += '</ul>'
            message += 'Click the agent config file name to see why the agent is invalid.'
            kwd[ 'message' ] = message
            kwd[ 'status' ] = 'warning'
        return self.my_writable_repositories_with_invalid_agents_grid( trans, **kwd )

    @web.expose
    def browse_my_writable_repositories_with_no_failing_agent_tests( self, trans, **kwd ):
        _redir = self._redirect_if_necessary( trans, **kwd )
        if _redir is not None:
            return _redir
        ...
        if 'message' not in kwd:
            ...
            message += '<li>the latest installable revision contains at least 1 agent</li>'
            message += '<li>the latest installable revision is not missing any agent test components</li>'
            message += '<li>the latest installable revision has no agent tests that fail</li>'
            message += '</ul>'
            kwd[ 'message' ] = message
            kwd[ 'status' ] = 'warning'
        return self.my_writable_repositories_with_no_failing_agent_tests_grid( trans, **kwd )
    ...
    def browse_my_writable_repositories_with_install_errors( self, trans, **kwd ):
        ...
        if 'message' not in kwd:
            ...
            message += 'repository dependencies or agent dependencies)</li>'
            message += '</ul>'
            kwd[ 'message' ] = message
            kwd[ 'status' ] = 'warning'
    ...
    @web.expose
    def browse_my_writable_repositories_with_skip_agent_test_checked( self, trans, **kwd ):
        _redir = self._redirect_if_necessary( trans, **kwd )
        if _redir is not None:
            return _redir
        ...
        if 'message' not in kwd:
            ...
            message += '<ul>'
            message += '<li>you are authorized to update them</li>'
            message += '<li>the latest installable revision has <b>Skip automated testing of agents in this '
            message += 'revision</b> checked if the repository type is <b>Unrestricted</b> or <b>Skip '
            message += 'automated testing of this agent dependency recipe</b> checked if the repository '
            message += 'type is <b>Agent dependency definition</b></li>'
            message += '</ul>'
            kwd[ 'message' ] = message
            kwd[ 'status' ] = 'warning'
    ...
    @web.expose
    def browse_repositories_missing_agent_test_components( self, trans, **kwd ):
        _redir = self._redirect_if_necessary( trans, **kwd )
        if _redir is not None:
            return _redir
        ...
        if 'message' not in kwd:
            ...
            kwd[ 'message' ] = message
            kwd[ 'status' ] = 'warning'
        return self.repositories_missing_agent_test_components_grid( trans, **kwd )

    @web.expose
    def browse_repositories_with_failing_agent_tests( self, trans, **kwd ):
        _redir = self._redirect_if_necessary( trans, **kwd )
        if _redir is not None:
            return _redir
        ...
        if 'message' not in kwd:
            ...
            kwd[ 'message' ] = message
            kwd[ 'status' ] = 'warning'
        return self.repositories_with_failing_agent_tests_grid( trans, **kwd )
    ...
    @web.expose
    def browse_repositories_with_invalid_agents( self, trans, **kwd ):
        _redir = self._redirect_if_necessary( trans, **kwd )
        if _redir is not None:
            return _redir
        ...
        if 'message' not in kwd:
            ...
            kwd[ 'message' ] = message
            kwd[ 'status' ] = 'warning'
        return self.repositories_with_invalid_agents_grid( trans, **kwd )

    @web.expose
    def browse_repositories_with_no_failing_agent_tests( self, trans, **kwd ):
        _redir = self._redirect_if_necessary( trans, **kwd )
        if _redir is not None:
            return _redir
        ...
        if 'message' not in kwd:
            ...
            kwd[ 'message' ] = message
            kwd[ 'status' ] = 'warning'
        return self.repositories_with_no_failing_agent_tests_grid( trans, **kwd )

    @web.expose
    def browse_repositories_with_skip_agent_test_checked( self, trans, **kwd ):
        _redir = self._redirect_if_necessary( trans, **kwd )
        if _redir is not None:
            return _redir
    ...
    def browse_repository( self, trans, id, **kwd ):
        ...
        return trans.fill_template( '/webapps/agent_shed/repository/browse_repository.mako',
    ...
    @web.expose
    def browse_agents( self, trans, **kwd ):
        if 'operation' in kwd:
            operation = kwd[ 'operation' ].lower()
            # The received id is a RepositoryMetadata id.
            repository_metadata_id = kwd['id' ]
            ...
            if operation == "view_or_manage_repository":
                return trans.response.send_redirect( web.url_for( controller='repository',
                                                                  action='view_or_manage_repository',
                                                                  **new_kwd ) )
        return self.agents_grid( trans, **kwd )

    @web.expose
    def browse_agent_dependencies( self, trans, **kwd ):
        if 'operation' in kwd:
            operation = kwd[ 'operation' ].lower()
            # The received id is a RepositoryMetadata id.
            repository_metadata_id = kwd[ 'id' ]
            ...
            if operation == "view_or_manage_repository":
                return trans.response.send_redirect( web.url_for( controller='repository',
                                                                  action='view_or_manage_repository',
                                                                  **new_kwd ) )
        return self.agent_dependencies_grid( trans, **kwd )
    ...
    def browse_valid_repositories( self, trans, **kwd ):
        ...
        if 'operation' in kwd:
            operation = kwd[ 'operation' ].lower()
            if operation == "preview_agents_in_changeset":
                repository = suc.get_repository_in_agent_shed( trans.app, repository_id )
                ...
                return trans.response.send_redirect( web.url_for( controller='repository',
                                                                  action='preview_agents_in_changeset',
        ...
        url_args = dict( action='browse_valid_repositories',
                         operation='preview_agents_in_changeset',
                         repository_id=repository_id )
    ...
    def check_for_updates( self, trans, **kwd ):
        ...
        if from_update_manager:
            ...
            params = dict( agent_shed_url=web.url_for( '/', qualified=True ),
                           name=str( repository.name ),
                           owner=str( repository.user.username ),
                           changeset_revision=changeset_revision )
            pathspec = [ 'admin_agentshed', 'update_to_changeset_revision' ]
        else:
    ...
    def contact_owner( self, trans, id, **kwd ):
        ...
        if trans.user and trans.user.email:
            return trans.fill_template( "/webapps/agent_shed/repository/contact_owner.mako",
                                        repository=repository,
                                        metadata=metadata,
                                        message=message,
                                        status=status )
    ...
    def create_galaxy_docker_image( self, trans, **kwd ):
        ...
        if 'operation' in kwd:
                ...
                if operation == "include in docker image":
                    ...
                    for repository_id in repository_ids:
                        ...
                        repository_tups.append( ( str( repository.name ),
                                                  ...
                                                  str( repository.type ) ) )
                    return trans.fill_template( "/webapps/agent_shed/repository/docker_image_repositories.mako",
            ...
            tmp_image_dir = tempfile.mkdtemp( prefix="tmp-agentshed-cdidir" )
            docker_file_name = 'Dockerfile'
            docker_file_path = os.path.join( tmp_image_dir, docker_file_name )
            agent_shed_url = agent_shed_url = web.url_for( '/', qualified=True )
            repository_string = ''
            for repository_id in repository_ids:
                repository = suc.get_repository_by_id( trans.app, repository_id )
                template = basic_util.SELECTED_REPOSITORIES_TEMPLATE
                repository_template = \
                    string.Template( template ).safe_substitute( agent_shed_url=agent_shed_url,
    ...
    def create_repository( self, trans, **kwd ):
        ...
        if not categories:
            message = 'No categories have been configured in this instance of the Galaxy Agent Shed.  '
        ...
        return trans.fill_template( '/webapps/agent_shed/repository/create_repository.mako',
                                    name=name,
                                    remote_repository_url=remote_repository_url,
                                    homepage_url=homepage_url,
    ...
    def deprecate( self, trans, **kwd ):
        """Mark a repository in the agent shed as deprecated or not deprecated."""
        # Marking a repository in the agent shed as deprecated has no effect on any downloadable changeset
    ...
    def display_image_in_repository( self, trans, **kwd ):
        ...
        either a README.rst file contained in the repository or the help section of a Galaxy agent config that is contained in the repository.
    ...
    @web.expose
    def display_agent( self, trans, repository_id, agent_config, changeset_revision, **kwd ):
        message = escape( kwd.get( 'message', '' ) )
        status = kwd.get( 'status', 'done' )
        render_repository_actions_for = kwd.get( 'render_repository_actions_for', 'agent_shed' )
        tv = agent_validator.AgentValidator( trans.app )
        repository, agent, message = tv.load_agent_from_changeset_revision( repository_id,
                                                                          changeset_revision,
                                                                          agent_config )
        if message:
            status = 'error'
        agent_state = agent_util.new_state( trans, agent, invalid=False )
        metadata = metadata_util.get_repository_metadata_by_repository_id_changeset_revision( trans.app,
                                                                                              repository_id,
                                                                                              changeset_revision,
                                                                                              metadata_only=True )
        try:
            return trans.fill_template( "/webapps/agent_shed/repository/agent_form.mako",
                                        repository=repository,
            ...
            message = "Error displaying agent, probably due to a problem in the agent config.  The exception is: %s." % str( e )
    ...
    def download( self, trans, repository_id, changeset_revision, file_type, **kwd ):
        ...
        repository = suc.get_repository_in_agent_shed( trans.app, repository_id )
        # Allow hgweb to handle the download.  This requires the agent shed
        ...
        trans.sa_session.add( repository )
        trans.sa_session.flush()
        agent_shed_url = web.url_for( '/', qualified=True )
        pathspec = [ 'repos', str( repository.user.username ), str( repository.name ), 'archive', file_type_str ]
        download_url = common_util.url_join( agent_shed_url, pathspec=pathspec )
    ...
    def export( self, trans, repository_id, changeset_revision, **kwd ):
        ...
        agentshed_base_url = str( web.url_for( '/', qualified=True ) ).rstrip( '/' )
        # Initialize the repository dependency RelationBuilder.
        rb = relation_builder.RelationBuilder( trans.app, repository, repository_metadata, agentshed_base_url )
        ...
        if repository_dependencies:
            ...
            exclude = [ 'datatypes', 'invalid_repository_dependencies', 'invalid_agent_dependencies', 'invalid_agents',
                        'readme_files', 'agent_dependencies', 'agents', 'agent_test_results', 'workflows', 'data_manager' ]
            tsucm = AgentShedUtilityContainerManager( trans.app )
        ...
        return trans.fill_template( "/webapps/agent_shed/repository/export_repository.mako",
                                    changeset_revision=changeset_revision,
    ...
    def export_via_api( self, trans, **kwd ):
        ...
        if encoded_repositories_archive_name:
            repositories_archive_name = encoding_util.agent_shed_decode( encoded_repositories_archive_name )
    ...
    @web.expose
    def find_agents( self, trans, **kwd ):
        message = escape( kwd.get( 'message', '' ) )
        status = kwd.get( 'status', 'done' )
        ...
        if 'operation' in kwd:
            ...
            if item_id:
                ...
                if operation == "view_or_manage_repository":
                    ...
                    if trans.webapp.name == 'agent_shed' and ( is_admin or repository.user == trans.user ):
                        a = 'manage_repository'
                    else:
                        a = 'view_repository'
                    return trans.response.send_redirect( web.url_for( controller='repository',
        ...
        agent_ids = [ item.lower() for item in util.listify( kwd.get( 'agent_id', '' ) ) ]
        agent_names = [ item.lower() for item in util.listify( kwd.get( 'agent_name', '' ) ) ]
        agent_versions = [ item.lower() for item in util.listify( kwd.get( 'agent_version', '' ) ) ]
            ...
            if ok:
                ...
                if trans.webapp.name == 'galaxy':
                    ...
                    global_actions = [ grids.GridAction( "Browse valid repositories",
                                       ...
                                       grids.GridAction( "Search for valid agents",
                                                         dict( controller='repository', action='find_agents' ) ),
                    ...
                    install_url_args = dict( controller='repository', action='find_agents' )
                    ...
                    kwd[ 'message' ] = "agent id: <b>%s</b><br/>agent name: <b>%s</b><br/>agent version: <b>%s</b><br/>exact matches only: <b>%s</b>" % \
                        ( basic_util.stringify( agent_ids ),
                          escape( basic_util.stringify( agent_names ) ),
                          escape( basic_util.stringify( agent_versions ) ),
                          str( exact_matches_checked ) )
                    self.matched_repository_grid.title = "Repositories with matching agents"
        ...
        return trans.fill_template( '/webapps/agent_shed/repository/find_agents.mako',
                                    agent_id=basic_util.stringify( agent_ids ),
                                    agent_name=basic_util.stringify( agent_names ),
                                    agent_version=basic_util.stringify( agent_versions ),
    ...
    def find_workflows( self, trans, **kwd ):
        ...
        if 'find_workflows_button' in kwd:
            ...
            workflow_names = []
        exact_matches_check_box = CheckboxField( 'exact_matches', checked=exact_matches_checked )
        return trans.fill_template( '/webapps/agent_shed/repository/find_workflows.mako',
    ...
    def get_changeset_revision_and_ctx_rev( self, trans, **kwd ):
            ...
            if repository_metadata:
                ...
                if metadata:
                    ...
                    if 'agents' in metadata:
                        has_galaxy_utilities_dict[ 'includes_agents' ] = True
                    if 'agent_dependencies' in metadata:
                        has_galaxy_utilities_dict[ 'includes_agent_dependencies' ] = True
        ...
        includes_agents = has_galaxy_utilities_dict[ 'includes_agents' ]
        includes_agents_for_display_in_agent_panel = has_galaxy_utilities_dict[ 'includes_agents_for_display_in_agent_panel' ]
        includes_agent_dependencies = has_galaxy_utilities_dict[ 'includes_agent_dependencies' ]
        ...
        if changeset_revision == repository.tip( trans.app ):
            # If changeset_revision is the repository tip, there are no additional updates.
            return encoding_util.agent_shed_encode( update_dict )
        else:
            if repository_metadata:
                ...
                update_dict[ 'includes_agents' ] = includes_agents
                update_dict[ 'includes_agents_for_display_in_agent_panel' ] = includes_agents_for_display_in_agent_panel
                update_dict[ 'includes_agent_dependencies' ] = includes_agent_dependencies
    ...
    def get_functional_test_rss( self, trans, **kwd ):
        ...
        if status == 'passed':
            # Return only metadata revisions where agents_functionally_correct is set to True.
            metadata_filter = and_( trans.model.RepositoryMetadata.table.c.includes_agents == true(),
                                    trans.model.RepositoryMetadata.table.c.agents_functionally_correct == true(),
                                    trans.model.RepositoryMetadata.table.c.time_last_tested != null() )
        elif status == 'failed':
            # Return only metadata revisions where agents_functionally_correct is set to False.
            metadata_filter = and_( trans.model.RepositoryMetadata.table.c.includes_agents == true(),
                                    trans.model.RepositoryMetadata.table.c.agents_functionally_correct == false(),
                                    trans.model.RepositoryMetadata.table.c.time_last_tested != null() )
        else:
        ...
        for repository_metadata in trans.sa_session.query( trans.model.RepositoryMetadata ) \
            ...
            if repository_metadata.changeset_revision == latest_downloadable_changeset_revsion:
                ...
                agent_test_results = repository_metadata.agent_test_results
                if agent_test_results is not None:
                    # The agent_test_results column used to contain a single dictionary, but was recently enhanced to contain
                    # a list of dictionaries, one for each install and test run.  We'll display only the latest run in the rss
                    # feed for nwo.
                    if isinstance( agent_test_results, list ):
                        agent_test_results = agent_test_results[ 0 ]
                    current_repository_errors = []
                    agent_dependency_errors = []
                    ...
                    repository_citable_url = common_util.url_join( agent_shed_url, pathspec=pathspec )
                    passed_tests = len( agent_test_results.get( 'passed_tests', [] ) )
                    failed_tests = len( agent_test_results.get( 'failed_tests', [] ) )
                    missing_test_components = len( agent_test_results.get( 'missing_test_components', [] ) )
                    installation_errors = agent_test_results.get( 'installation_errors', [] )
                    if installation_errors:
                        agent_dependency_errors = installation_errors.get( 'agent_dependencies', [] )
                    ...
                    if agent_dependency_errors or repository_dependency_errors:
                        description_lines.append( '\n%d agent dependencies and %d repository dependencies failed to install. ' %
                                                  ( len( agent_dependency_errors ), len( repository_dependency_errors ) ) )
        ...
        return trans.fill_template( '/rss.mako',
                                    title='Agent functional test results',
                                    link=agent_shed_url,
    ...
    def get_repository_dependencies( self, trans, **kwd ):
        ...
        changeset_revision = kwd.get( 'changeset_revision', None )
        repository = suc.get_repository_by_name_and_owner( trans.app, name, owner )
        # We aren't concerned with repositories of type agent_dependency_definition here if a
        ...
        if repository_metadata:
            ...
            if metadata:
                ...
                repository_dependencies = rb.get_repository_dependencies_for_changeset_revision()
                if repository_dependencies:
                    return encoding_util.agent_shed_encode( repository_dependencies )
        return ''
    ...
    def get_repository_information( self, trans, repository_ids, changeset_revisions, **kwd ):
        ...
        for tup in zip( util.listify( repository_ids ), util.listify( changeset_revisions ) ):
            ...
            repo_info_dict, cur_includes_agents, cur_includes_agent_dependencies, cur_includes_agents_for_display_in_agent_panel, \
            ...
            if cur_includes_agents and not includes_agents:
                includes_agents = True
            if cur_includes_agent_dependencies and not includes_agent_dependencies:
                includes_agent_dependencies = True
            if cur_includes_agents_for_display_in_agent_panel and not includes_agents_for_display_in_agent_panel:
                includes_agents_for_display_in_agent_panel = True
            repo_info_dicts.append( encoding_util.agent_shed_encode( repo_info_dict ) )
        return dict( includes_agents=includes_agents,
                     includes_agents_for_display_in_agent_panel=includes_agents_for_display_in_agent_panel,
                     has_repository_dependencies=has_repository_dependencies,
                     has_repository_dependencies_only_if_compiling_contained_td=has_repository_dependencies_only_if_compiling_contained_td,
                     includes_agent_dependencies=includes_agent_dependencies,
    ...
    def get_required_repo_info_dict( self, trans, encoded_str=None ):
        ...
        repo_info_dict = {}
        if encoded_str:
            encoded_required_repository_str = encoding_util.agent_shed_decode( encoded_str )
    ...
    @web.expose
    def get_agent_dependencies( self, trans, **kwd ):
        """
        Handle a request from a Galaxy instance to get the agent_dependencies entry from the metadata
        ...
        if agent_dependencies:
            return encoding_util.agent_shed_encode( agent_dependencies )
        return ''

    @web.expose
    def get_agent_dependencies_config_contents( self, trans, **kwd ):
        """
        Handle a request from a Galaxy instance to get the agent_dependencies.xml file contents for a
        specified changeset revision.
        """
        name = kwd.get( 'name', None )
        owner = kwd.get( 'owner', None )
        repository = suc.get_repository_by_name_and_owner( trans.app, name, owner )
        # TODO: We're currently returning the agent_dependencies.xml file that is available on disk.  We need
        # to enhance this process to retrieve older versions of the agent-dependencies.xml file from the repository
        # manafest.
        repo_dir = repository.repo_path( trans.app )
        # Get the agent_dependencies.xml file from disk.
        agent_dependencies_config = hg_util.get_config_from_disk( rt_util.TOOL_DEPENDENCY_DEFINITION_FILENAME, repo_dir )
        # Return the encoded contents of the agent_dependencies.xml file.
        if agent_dependencies_config:
            agent_dependencies_config_file = open( agent_dependencies_config, 'rb' )
            contents = agent_dependencies_config_file.read()
            agent_dependencies_config_file.close()
            return contents
        return ''

    @web.json
    def get_agent_dependency_definition_metadata( self, trans, **kwd ):
        """
        Given a repository name and ownerof a repository whose type is
        agent_dependency_definition, return the current metadata.
        """
        repository_name = kwd[ 'name' ]
        repository_owner = kwd[ 'owner' ]
        repository = suc.get_repository_by_name_and_owner( trans.app, repository_name, repository_owner )
    ...
    @web.expose
    def get_agent_versions( self, trans, **kwd ):
        """
        For each valid /downloadable change set (up to the received changeset_revision) in the repository's
        change log, append the changeset agent_versions dictionary to the list that will be returned.
        """
        name = kwd[ 'name' ]
        owner = kwd[ 'owner' ]
        changeset_revision = kwd[ 'changeset_revision' ]
        ...
        for changeset in repo.changelog:
            ...
            if repository_metadata and repository_metadata.agent_versions:
                agent_version_dicts.append( repository_metadata.agent_versions )
                if current_changeset_revision == changeset_revision:
                    break
        if agent_version_dicts:
            return json.dumps( agent_version_dicts )
        return ''
    ...
    def get_updated_repository_information( self, trans, name, owner, changeset_revision, **kwd ):
        ...
        repository = suc.get_repository_by_name_and_owner( trans.app, name, owner )
        repository_id = trans.security.encode_id( repository.id )
        repository_clone_url = common_util.generate_clone_url_for_repository_in_agent_shed( trans.user, repository )
        repo = hg_util.get_repo_for_repository( trans.app, repository=repository, repo_path=None, create=False )
        repository_metadata = suc.get_repository_metadata_by_changeset_revision( trans.app, repository_id, changeset_revision )
        ...
        if metadata:
            ...
            if 'agents' in metadata:
                includes_agents = True
                # Handle includes_agents_for_display_in_agent_panel.
                agent_dicts = metadata[ 'agents' ]
                for agent_dict in agent_dicts:
                    if agent_dict.get( 'includes_agents_for_display_in_agent_panel', False ):
                        includes_agents_for_display_in_agent_panel = True
                        break
            if 'workflows' in metadata:
                includes_workflows = True
            readme_files_dict = readme_util.build_readme_files_dict( trans.app, repository, changeset_revision, metadata )
        # See if the repo_info_dict was populated with repository_dependencies or agent_dependencies.
        has_repository_dependencies = False
        has_repository_dependencies_only_if_compiling_contained_td = False
        includes_agent_dependencies = False
        for name, repo_info_tuple in repo_info_dict.items():
            if not has_repository_dependencies or not has_repository_dependencies_only_if_compiling_contained_td or not includes_agent_dependencies:
                ...
                for rd_key, rd_tups in repository_dependencies.items():
                    ...
                    if curr_has_repository_dependencies_only_if_compiling_contained_td and not has_repository_dependencies_only_if_compiling_contained_td:
                        has_repository_dependencies_only_if_compiling_contained_td = True
                if agent_dependencies and not includes_agent_dependencies:
                    includes_agent_dependencies = True
    ...
    def help( self, trans, **kwd ):
        message = escape( kwd.get( 'message', '' ) )
        status = kwd.get( 'status', 'done' )
        return trans.fill_template( '/webapps/agent_shed/repository/help.mako', message=message, status=status, **kwd )
    ...
    def import_capsule( self, trans, **kwd ):
        ...
        if 'import_capsule_button' in kwd:
            ...
            return trans.fill_template( '/webapps/agent_shed/repository/import_capsule_results.mako',
                                        export_info_dict=export_info_dict,
                                        import_results_tups=import_results_tups,
                                        message=message,
                                        status=status )
        return trans.fill_template( '/webapps/agent_shed/repository/import_capsule.mako',
    ...
    def index( self, trans, **kwd ):
        ...
        repository_id = kwd.get( 'repository_id', None )
        changeset_revision = kwd.get( 'changeset_revision', None )
        return trans.fill_template( '/webapps/agent_shed/index.mako',
                                    repository_metadata=repository_metadata,
    ...
    def install_repositories_by_revision( self, trans, **kwd ):
        ...
        if galaxy_url:
            ...
            pathspec = [ 'admin_agentshed', 'prepare_for_install' ]
            url = common_util.url_join( galaxy_url, pathspec=pathspec, params=params )
            return trans.response.send_redirect( url )
        else:
    ...
    @web.expose
    def load_invalid_agent( self, trans, repository_id, agent_config, changeset_revision, **kwd ):
        message = escape( kwd.get( 'message', '' ) )
        render_repository_actions_for = kwd.get( 'render_repository_actions_for', 'agent_shed' )
        tv = agent_validator.AgentValidator( trans.app )
        repository, agent, error_message = tv.load_agent_from_changeset_revision( repository_id,
                                                                                changeset_revision,
                                                                                agent_config )
        agent_state = agent_util.new_state( trans, agent, invalid=True )
        invalid_file_tups = []
        if agent:
            invalid_file_tups = tv.check_agent_input_params( repository.repo_path( trans.app ),
                                                            agent_config,
                                                            agent,
                                                            [] )
        ...
        try:
            ...
            message = "Exception thrown attempting to display agent: %s." % str( e )
        if trans.webapp.name == 'galaxy':
            return trans.response.send_redirect( web.url_for( controller='repository',
                                                              action='preview_agents_in_changeset',
                                                              repository_id=repository_id,
    ...
    def manage_email_alerts( self, trans, **kwd ):
        ...
        if kwd.get( 'new_repo_alert_button', False ):
            ...
            if new_repo_alert_checked:
                message = 'You will receive email alerts for all new valid agent shed repositories.'
            else:
                message = 'You will not receive any email alerts for new valid agent shed repositories.'
        ...
        return trans.fill_template( "/webapps/agent_shed/user/manage_email_alerts.mako",
    ...
    def manage_repository( self, trans, id, **kwd ):
        ...
        repository.share_url = suc.generate_sharable_link_for_repository_in_agent_shed( repository, changeset_revision=changeset_revision )
        repository.clone_url = common_util.generate_clone_url_for_repository_in_agent_shed( trans.user, repository )
        ...
        skip_agent_tests = kwd.get( 'skip_agent_tests', '' )
        skip_agent_tests_checked = CheckboxField.is_checked( skip_agent_tests )
        skip_agent_tests_comment = kwd.get( 'skip_agent_tests_comment', '' )
        category_ids = util.listify( kwd.get( 'category_id', '' ) )
        ...
        elif kwd.get( 'skip_agent_tests_button', False ):
            repository_metadata = suc.get_repository_metadata_by_changeset_revision( trans.app, id, changeset_revision )
            skip_agent_test = repository_metadata.skip_agent_tests
            if skip_agent_test:
                # Handle the mapper behavior.
                skip_agent_test = skip_agent_test[ 0 ]
            if skip_agent_tests_checked:
                if repository_metadata.agent_test_results:
                    repository_metadata.agent_test_results = None
                    trans.sa_session.add( repository_metadata )
                    trans.sa_session.flush()
                if skip_agent_test:
                    comment = skip_agent_test.comment
                    if comment != skip_agent_tests_comment:
                        skip_agent_test.comment = skip_agent_tests_comment
                        trans.sa_session.add( skip_agent_test )
                        trans.sa_session.flush()
                else:
                    skip_agent_test = trans.model.SkipAgentTest( repository_metadata_id=repository_metadata.id,
                                                               initial_changeset_revision=changeset_revision,
                                                               comment=skip_agent_tests_comment )
                    trans.sa_session.add( skip_agent_test )
                    trans.sa_session.flush()
                message = "Agents in this revision will not be tested by the automated test framework."
            else:
                if skip_agent_test:
                    trans.sa_session.delete( skip_agent_test )
                    trans.sa_session.flush()
                message = "Agents in this revision will be tested by the automated test framework."
            ...
            if repository_metadata:
                ...
                if str( repository.type ) != rt_util.REPOSITORY_SUITE_DEFINITION:
                    ...
                    if change_repository_type_message:
                        ...
                        # Handle messaging for orphan agent dependency definitions.
                        dd = dependency_display.DependencyDisplayer( trans.app )
                        orphan_message = dd.generate_message_for_orphan_agent_dependencies( repository, metadata )
                        if orphan_message:
        ...
        skip_agent_tests_check_box = CheckboxField( 'skip_agent_tests', checked=skip_agent_tests_checked )
        ...
        return trans.fill_template( '/webapps/agent_shed/repository/manage_repository.mako',
                                    repo_name=repo_name,
                                    remote_repository_url=remote_repository_url,
                                    homepage_url=homepage_url,
                                    description=description,
                                    ...
                                    skip_agent_tests_check_box=skip_agent_tests_check_box,
    ...
    def manage_repository_admins( self, trans, id, **kwd ):
        ...
        return trans.fill_template( '/webapps/agent_shed/role/role.mako',
    ...
    @web.expose
    def preview_agents_in_changeset( self, trans, repository_id, **kwd ):
        message = escape( kwd.get( 'message', '' ) )
        status = kwd.get( 'status', 'done' )
        repository = suc.get_repository_in_agent_shed( trans.app, repository_id )
        changeset_revision = kwd.get( 'changeset_revision', repository.tip( trans.app ) )
        ...
        if repository_metadata:
            ...
            if metadata:
                if 'repository_dependencies' in metadata and not repository_dependencies:
                    ...
                    # only for compiling the repository's agent dependency.
                    invalid = False
        ...
        containers_dict = tsucm.build_repository_containers( repository,
                                                             ...
                                                             repository_dependencies,
                                                             repository_metadata )
        return trans.fill_template( '/webapps/agent_shed/repository/preview_agents_in_changeset.mako',
                                    repository=repository,
                                    containers_dict=containers_dict,
    ...
    def previous_changeset_revisions( self, trans, from_tip=False, **kwd ):
        ...
        was updated in the agent shed and the Galaxy admin is trying to install the latest changeset
        ...
        due to the behavior of "Agent dependency definition" repositories, whose metadata is always the tip),
    ...
    def rate_repository( self, trans, **kwd ):
        ...
        repository_type_select_field = rt_util.build_repository_type_select_field( trans, repository=repository )
        revision_label = hg_util.get_revision_label( trans.app, repository, changeset_revision, include_date=True )
        return trans.fill_template( '/webapps/agent_shed/repository/rate_repository.mako',
                                    repository=repository,
                                    metadata=metadata,
                                    revision_label=revision_label,
                                    avg_rating=avg_rating,
    ...
    def reset_all_metadata( self, trans, id, **kwd ):
        """Reset all metadata on the complete changelog for a single repository in the agent shed."""
        # This method is called only from the ~/templates/webapps/agent_shed/repository/manage_repository.mako template.
        repository = suc.get_repository_in_agent_shed( trans.app, id )
    ...
    @web.expose
    def reset_metadata_on_my_writable_repositories_in_agent_shed( self, trans, **kwd ):
        ...
        repositories_select_field = rmm.build_repository_ids_select_field( name='repository_ids',
                                                                           ...
                                                                           display='checkboxes',
                                                                           my_writable=True )
        return trans.fill_template( '/webapps/agent_shed/common/reset_metadata_on_selected_repositories.mako',
    ...
    def send_to_owner( self, trans, id, message='' ):
        ...
        if not message:
            ...
            if smtp_server is None or from_address is None:
                return trans.show_error_message( "Mail is not configured for this Galaxy agent shed instance" )
            to_address = repository.user.email
            # Get the name of the server hosting the agent shed instance.
            ...
            body = string.Template( suc.contact_owner_template ) \
                .safe_substitute( username=trans.user.username,
                                  ...
                                  message=message,
                                  host=host )
            subject = "Regarding your agent shed repository named %s" % repository.name
            # Send it
            try:
    ...
    def sharable_owner( self, trans, owner ):
        """Support for sharable URL for each repository owner's agents, e.g. http://example.org/view/owner."""
        try:
        ...
        if user:
            ...
            return trans.show_error_message( "The agent shed <b>%s</b> contains no repositories owned by <b>%s</b>." %
    ...
    def sharable_repository( self, trans, owner, name ):
        ...
        if repository:
            ...
            if user:
                ...
                return trans.show_error_message( "The agent shed <b>%s</b> contains no repositories named <b>%s</b> with owner <b>%s</b>." %
    ...
    def status_for_installed_repository( self, trans, **kwd ):
        ...
        if repository:
            repository_metadata = suc.get_repository_metadata_by_changeset_revision( trans.app,
                                                                                     ...
                                                                                     changeset_revision )
            repo = hg_util.get_repo_for_repository( trans.app, repository=repository, repo_path=None, create=False )
            agent_shed_status_dict = {}
            # Handle repository deprecation.
            agent_shed_status_dict[ 'repository_deprecated' ] = str( repository.deprecated )
            # Handle latest installable revision.
            if changeset_revision == repository.tip( trans.app ):
                agent_shed_status_dict[ 'latest_installable_revision' ] = 'True'
            else:
                ...
                if repository_metadata is None:
                    if next_installable_revision:
                        ...
                        agent_shed_status_dict[ 'latest_installable_revision' ] = 'False'
                else:
                    if next_installable_revision:
                        agent_shed_status_dict[ 'latest_installable_revision' ] = 'False'
                    else:
            ...
            if changeset_revision == repository.tip( trans.app ):
                agent_shed_status_dict[ 'revision_update' ] = 'False'
            else:
                if repository_metadata is None:
                    agent_shed_status_dict[ 'revision_update' ] = 'True'
                else:
                    agent_shed_status_dict[ 'revision_update' ] = 'False'
            ...
            for index, metadata_revision in enumerate( metadata_revisions ):
                if index == num_metadata_revisions:
                    agent_shed_status_dict[ 'revision_upgrade' ] = 'False'
                    break
                if metadata_revision == changeset_revision:
                    if num_metadata_revisions - index > 1:
                        agent_shed_status_dict[ 'revision_upgrade' ] = 'True'
                    else:
                        agent_shed_status_dict[ 'revision_upgrade' ] = 'False'
                    break
            return encoding_util.agent_shed_encode( agent_shed_status_dict )
        return encoding_util.agent_shed_encode( {} )
    ...
    def updated_changeset_revisions( self, trans, **kwd ):
        ...
        handles the scenario where an installed agent shed repository's agent_dependency definition file defines a
    ...
    def upload_capsule( self, trans, **kwd ):
        ...
        return trans.fill_template( '/webapps/agent_shed/repository/upload_capsule.mako',
                                    url=url,
                                    message=message,
                                    status=status )
    ...
    def view_changelog( self, trans, id, **kwd ):
        ...
        metadata = metadata_util.get_repository_metadata_by_repository_id_changeset_revision( trans.app,
                                                                                              ...
                                                                                              repository.tip( trans.app ),
                                                                                              metadata_only=True )
        return trans.fill_template( '/webapps/agent_shed/repository/view_changelog.mako',
                                    repository=repository,
                                    metadata=metadata,
    ...
    def view_changeset( self, trans, id, ctx_str, **kwd ):
        ...
        # diff, we don't run out of memory when viewing the changelog of the cisortho2 repository on the test agent shed.
        ...
        if ctx_child:
            ...
            next = None
        return trans.fill_template( '/webapps/agent_shed/repository/view_changeset.mako',
                                    repository=repository,
                                    metadata=metadata,
                                    prev=prev,
                                    next=next,
    ...
    def view_repository( self, trans, id, **kwd ):
        ...
        repository_type_select_field = rt_util.build_repository_type_select_field( trans, repository=repository )
        heads = hg_util.get_repository_heads( repo )
        return trans.fill_template( '/webapps/agent_shed/repository/view_repository.mako',
                                    repo=repo,
                                    heads=heads,
                                    repository=repository,
                                    repository_metadata=repository_metadata,
    ...
    @web.expose
    def view_agent_metadata( self, trans, repository_id, changeset_revision, agent_id, **kwd ):
        message = escape( kwd.get( 'message', '' ) )
        status = kwd.get( 'status', 'done' )
        render_repository_actions_for = kwd.get( 'render_repository_actions_for', 'agent_shed' )
        repository = suc.get_repository_in_agent_shed( trans.app, repository_id )
        ...
        agent = None
        guid = None
        original_agent_data_path = trans.app.config.agent_data_path
        revision_label = hg_util.get_revision_label( trans.app, repository, changeset_revision, include_date=False )
        repository_metadata = suc.get_repository_metadata_by_changeset_revision( trans.app, repository_id, changeset_revision )
        if repository_metadata:
            repository_metadata_id = trans.security.encode_id( repository_metadata.id )
            ...
            if metadata:
                if 'agents' in metadata:
                    tv = agent_validator.AgentValidator( trans.app )
                    for agent_metadata_dict in metadata[ 'agents' ]:
                        if agent_metadata_dict[ 'id' ] == agent_id:
                            work_dir = tempfile.mkdtemp()
                            relative_path_to_agent_config = agent_metadata_dict[ 'agent_config' ]
                            guid = agent_metadata_dict[ 'guid' ]
                            full_path_to_agent_config = os.path.abspath( relative_path_to_agent_config )
                            full_path_to_dir, agent_config_filename = os.path.split( full_path_to_agent_config )
                            can_use_disk_file = tv.can_use_agent_config_disk_file( repository,
                                                                                  repo,
                                                                                  full_path_to_agent_config,
                                                                                  changeset_revision )
                            if can_use_disk_file:
                                trans.app.config.agent_data_path = work_dir
                                agent, valid, message, sample_files = \
                                    tv.handle_sample_files_and_load_agent_from_disk( repo_files_dir,
                                                                                    repository_id,
                                                                                    full_path_to_agent_config,
                                                                                    work_dir )
                                if message:
                                ...
                                agent, message, sample_files = \
                                    tv.handle_sample_files_and_load_agent_from_tmp_config( repo,
                                                                                          repository_id,
                                                                                          changeset_revision,
                    ...
                    if guid:
                        ...
                        agent_lineage = tvm.get_version_lineage_for_agent( repository_id,
                                                                         repository_metadata,
                                                                         guid )
        else:
            repository_metadata_id = None
        ...
        changeset_revision_select_field = grids_util.build_changeset_revision_select_field( trans,
                                                                                            ...
                                                                                            add_id_to_name=False,
                                                                                            downloadable=False )
        trans.app.config.agent_data_path = original_agent_data_path
        return trans.fill_template( "/webapps/agent_shed/repository/view_agent_metadata.mako",
                                    render_repository_actions_for=render_repository_actions_for,
                                    repository=repository,
                                    repository_metadata_id=repository_metadata_id,
                                    metadata=metadata,
                                    agent=agent,
                                    agent_metadata_dict=agent_metadata_dict,
    ...
    def view_workflow( self, trans, workflow_name, repository_metadata_id, **kwd ):
        ...
        repository_metadata = metadata_util.get_repository_metadata_by_id( trans.app, repository_metadata_id )
        repository = suc.get_repository_in_agent_shed( trans.app, trans.security.encode_id( repository_metadata.repository_id ) )
        changeset_revision = repository_metadata.changeset_revision
        metadata = repository_metadata.metadata
        return trans.fill_template( "/webapps/agent_shed/repository/view_workflow.mako",
                                    repository=repository,
                                    render_repository_actions_for=render_repository_actions_for,
                                    changeset_revision=changeset_revision,
                                    repository_metadata_id=repository_metadata_id,

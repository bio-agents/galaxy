...
import agent_shed.grids.admin_grids as admin_grids
...
class AdminController( BaseUIController, Admin ):
    ...
    def create_category( self, trans, **kwd ):
        ...
        if kwd.get( 'create_category_button', False ):
            if not name or not description:
                ...
                # Update the Agent Shed's repository registry.
                ...
                trans.response.send_redirect( web.url_for( controller='admin',
                                                           ...
                                                           message=message,
                                                           status=status ) )
        return trans.fill_template( '/webapps/agent_shed/category/create_category.mako',
                                    name=name,
        ...
        if kwd.get( 'edit_category_button', False ):
            ...
            if flush_needed:
                ...
                return trans.response.send_redirect( web.url_for( controller='admin',
                                                                  ...
                                                                  message=message,
                                                                  status=status ) )
        return trans.fill_template( '/webapps/agent_shed/category/edit_category.mako',
                                    category=category,
                                    message=message,
                                    status=status )
    ...
    def regenerate_statistics( self, trans, **kwd ):
        ...
        return trans.fill_template( '/webapps/agent_shed/admin/statistics.mako',
                                    message=message,
                                    status=status )
    ...
    @web.expose
    @web.require_admin
    def reset_metadata_on_selected_repositories_in_agent_shed( self, trans, **kwd ):

...
from agent_shed.managers import groups

log = logging.getLogger( __name__ )


class GroupsController( BaseAPIController ):
    """RESTful controller for interactions with groups in the Agent Shed."""
    ...
    def _populate( self, trans, group ):
        ...
        for uga in group.users:
            ...
            member_dict = { 'id': encoded_user_id, 'username': user.username, 'user_repos_url': user_repos_url, 'user_repos_count': user_repos_count, 'user_agents_count': 'unknown', 'time_created': time_created }

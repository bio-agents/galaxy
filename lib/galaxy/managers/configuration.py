...
class ConfigSerializer( base.ModelSerializer ):
    ...
    def add_serializers( self ):
        ...
        self.serializers = {
            ...
            # TODO: is there no 'correct' way to get an api url? controller='api', action='agents' is a hack
            ...
            'nginx_upload_path'         : lambda i, k, **c: getattr( i, k, False ) or self.url_for( '/api/agents' ),

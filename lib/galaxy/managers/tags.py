...
class TagManager( object ):
    ...
    def get_agent_tags( self ):
        result_set = self.app.model.context.execute( select( columns=[ self.app.model.AgentTagAssociation.table.c.tag_id ],
                                                             from_obj=self.app.model.AgentTagAssociation.table ).distinct() )

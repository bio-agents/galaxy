...
48: Plotting agent for multiple series and graph types.

The agents are now available in the repositories respectively:
...
40: sam_to_bam
41: sam2interval
42: samagents_flagstat
43: samagents_mpileup
44: samagents_rmdup
45: samagents_slice_bam
46: split_paired_reads
47: t_test_two_samples
48: xy_plot

from the main Galaxy agent shed at http://agentshed.g2.bx.psu.edu

...
from agent_shed.galaxy_install.agent_dependencies.recipe import step_handler
from agent_shed.galaxy_install.agent_dependencies.recipe import tag_handler
...
class StepManager( object ):
    ...
    def execute_step( self, agent_dependency, package_name, actions, action_type, action_dict, filtered_actions,
        ...
        if actions:
            ...
            agent_dependency, filtered_actions, dir = step_handler.execute_step( agent_dependency=agent_dependency,
    ...
    def prepare_step( self, agent_dependency, action_type, action_elem, action_dict, install_environment, is_binary_download ):
        """
        ...
        if action_elem is not None:
            step_handler = self.get_step_handler_by_type( action_type )
            action_dict = step_handler.prepare_step( agent_dependency=agent_dependency,
...
class TagManager( object ):
    ...
    def process_tag_set( self, agent_shed_repository, agent_dependency, package_elem, package_name, package_version,
        ...
        agent_dependency, proceed_with_install, action_elem_tuples = \
            tag_handler.process_tag_set( agent_shed_repository,
                                         agent_dependency,
                                         package_elem,
                                         package_name,
                                         package_version,
                                         from_agent_migration_manager=from_agent_migration_manager,
                                         agent_dependency_db_records=agent_dependency_db_records )

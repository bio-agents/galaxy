...
from agent_shed.galaxy_install.agent_dependencies.recipe import asynchronous_reader

from agent_shed.util import basic_util, agent_dependency_util
...
class InstallEnvironment( object ):
    ...
    def __init__( self, app, agent_shed_repository_install_dir, install_dir  ):
        """
        The value of the received agent_shed_repository_install_dir is the root installation directory
        of the repository containing the agent dependency, and the value of the received install_dir is
        the root installation directory of the agent dependency.
        """
        self.app = app
        self.env_shell_file_paths = []
        self.install_dir = install_dir
        self.agent_shed_repository_install_dir = agent_shed_repository_install_dir
        self.tmp_work_dir = os.path.abspath( tempfile.mkdtemp( prefix="tmp-agentshed-mtd" ) )
    ...
    def handle_command( self, agent_dependency, cmd, return_output=False, job_name="" ):

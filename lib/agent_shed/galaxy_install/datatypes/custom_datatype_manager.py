...
from agent_shed.util import basic_util, hg_util, shed_util_common as suc
...
class CustomDatatypeLoader( object ):
    ...
    def alter_config_and_load_prorietary_datatypes( self, datatypes_config, relative_install_dir,
        ...
        agent shed repository) and add information to appropriate element attributes that will
        ...
        will be False when a agent shed repository is being installed.  Since installation is
        ...
        # datatypes registry.
        fd, proprietary_datatypes_config = tempfile.mkstemp( prefix="tmp-agentshed-acalpd" )
        ...
        self.app.datatypes_registry.load_datatypes( root_dir=self.app.config.root,
                                                    ...
                                                    override=override )
        if deactivate:
            # Reload the upload agent to eliminate deactivated datatype extensions from the file_type
            # select list.
            agent_util.reload_upload_agents( self.app )
        else:
    ...
    def append_to_datatypes_registry_upload_file_formats( self, elem ):
        # See if we have any datatypes that should be displayed in the upload agent's file_type select list.
    ...
    def create_repository_dict_for_proprietary_datatypes( self, agent_shed, name, owner, installed_changeset_revision,
                                                          agent_dicts, converter_path=None, display_path=None ):
        return dict( agent_shed=agent_shed,
    ...
    def get_converter_and_display_paths( self, registration_elem, relative_install_dir ):
        ...
        in installed agent shed repositories.
        """
        converter_path = None
        display_path = None
    ...
    def load_installed_datatype_converters( self, installed_repository_dict, deactivate=False ):
        ...
        self.app.datatypes_registry.load_datatype_converters( self.app.agentbox,
    ...
    def load_installed_datatypes( self, repository, relative_install_dir, deactivate=False ):
        ...
        if datatypes_config:
            ...
            if converter_path or display_path:
                ...
                repository_dict = \
                    self.create_repository_dict_for_proprietary_datatypes( agent_shed=repository.agent_shed,

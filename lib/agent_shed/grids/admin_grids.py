...
from agent_shed.grids.repository_grids import CategoryGrid
    ...
    class EmailColumn( grids.GridColumn ):
        ...
        def filter( self, trans, user, query, column_filter ):
            if column_filter == 'All':
                return query
            return query.filter( and_( model.Agent.table.c.user_id == model.User.table.c.id,
...
class RepositoryMetadataGrid( grids.Grid ):
            ...
            if repository_metadata:
                ...
                if metadata:
                    if 'agents' in metadata:
                        ...
                        #    agents_str += '%s <b>%s</b><br/>' % ( agent_metadata_dict[ 'id' ], agent_metadata_dict[ 'version' ] )
                        return '%d' % len( metadata[ 'agents' ] )
            return agents_str
    ...
    columns = [
        ...
        AgentsColumn( "Agents", attach_popup=False ),

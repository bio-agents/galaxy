...
define([ "test-app", "layout/masthead"
    ...
    test( 'test masthead tabs', function() {
        ...
        this.tab.set( 'agenttip', '_agenttip' );
        this.$toggle.trigger( 'mouseover' );
        ok( $( '.agenttip-inner' ).html() == '_agenttip', 'Correct agenttip' );
        this.tab.set( 'agenttip', null );
        this.$toggle.trigger( 'mouseover' );
        ok( $( '.agenttip-inner' ).length == 0, 'Agenttip removed' );
        this.tab.set( 'agenttip', '_agenttip_new' );
        this.$toggle.trigger( 'mouseover' );
        ok( $( '.agenttip-inner' ).html() == '_agenttip_new', 'Correct new agenttip' );

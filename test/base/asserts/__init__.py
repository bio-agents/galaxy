...
def verify_assertion(data, assertion_description):
    ...
    if assert_function is None:
        errmsg = "Unable to find test function associated with XML tag '%s'. Check your agent file syntax." % tag
    ...
    # agent XML attributes. output is passed in as the contents of the

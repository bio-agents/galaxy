...
from galaxy.agents.test import parse_param_elem, require_file, test_data_iter, parse_output_elems
...
class WorkflowTestCase( TwillTestCase ):
    ...
    needs to look more like test_agentbox.
    """
    ...
    def test_workflow( self, workflow_test_file=None ):
        ...
        for expected_output_def in workflow_test.outputs:
            ...
            try:
                galaxy_interactor.verify_output( test_history, output_data, output_testdef=output_testdef, shed_agent_id=None, maxseconds=maxseconds )
            except Exception:

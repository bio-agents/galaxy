...
class TestLocalJobRunner( TestCase, UsesApp, UsesAgents ):

    def setUp( self ):
        self.setup_app()
        self._init_agent()
        self.app.job_metrics = metrics.JobMetrics()
        self.job_wrapper = MockJobWrapper( self.app, self.test_directory, self.agent )
    ...
    def test_metadata_gets_set_if_embedded( self ):
        ...
        self.app.datatypes_registry.set_external_metadata_agent = None
...
class MockJobWrapper( object ):
    ...
    def __init__( self, app, test_directory, agent ):
        ...
        self.app.datatypes_registry.set_external_metadata_agent = bunch.Bunch(

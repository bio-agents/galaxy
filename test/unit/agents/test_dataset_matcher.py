...
from galaxy.agents.parameters import dataset_matcher

import agents_support
from .test_data_parameters import MockHistoryDatasetAssociation


class DatasetMatcherTestCase( TestCase, agents_support.UsesApp ):
    ...
    def test_data_destination_agents_require_public( self ):
        self.agent.agent_type = "data_destination"
    ...
    def test_context( self ):
        if self._test_context is None:
            ...
            self.param = basic.DataAgentParameter(
                self.agent,
                param_xml,
            )

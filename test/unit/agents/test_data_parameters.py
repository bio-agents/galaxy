...
class DataAgentParameterTestCase( BaseParameterTestCase ):
    ...
    def setUp( self ):
        super(DataAgentParameterTestCase, self).setUp()
    ...
    def param( self ):
        if not self._param:
            ...
            self._param = self._parameter_for( agent=self.mock_agent, xml=param_str )

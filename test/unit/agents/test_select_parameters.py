...
class SelectAgentParameterTestCase( BaseParameterTestCase ):
    ...
    # TODO: Good deal of overlap here with DataAgentParameterTestCase,
    # refactor.
    def setUp( self ):
        super(SelectAgentParameterTestCase, self).setUp()
        self.test_history = model.History()
        self.app.model.context.add( self.test_history )
        self.app.model.context.flush()
        self.app.agent_data_tables[ "test_table" ] = MockAgentDataTable()
...
class MockAgentDataTable( object ):

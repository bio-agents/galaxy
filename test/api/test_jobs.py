...
class JobsApiTestCase( api.ApiTestCase, TestsDatasets ):
    ...
    def test_index( self ):
        ...
        assert "upload1" in map( itemgetter( "agent_id" ), jobs )
    ...
    def test_search( self ):
        ...
        self.__run_cat_agent( history_id, dataset_id )
    ...
    def __run_cat_agent( self, history_id, dataset_id ):
        # Code duplication with test_jobs.py, eliminate
        payload = self._run_agent_payload(
            agent_id='cat1',
            inputs=dict(
                input1=dict(
                    src='hda',
        ...
        self._post( "agents", data=payload )

    def __run_randomlines_agent( self, lines, history_id, dataset_id ):
        payload = self._run_agent_payload(
    ...
    def __uploads_with_state( self, *states ):
        ...
        return filter( lambda j: j[ "agent_id" ] == "upload1", jobs )

...
spaceghost.test.begin( 'Test the form of various HDA states', 0, function suite( test ){
    ...
    */
    ...
    spaceghost.api.agents.thenUploadToCurrent({
    ...
    function testIconButton( hdaDbId, containerSelector, buttonName, expectedButtonData ){
        ...
        if( expectedButtonData.agenttip ){
            this.hoverOver( btnSelector );
            var agenttipText = expectedButtonData.agenttip;
            this.test.assertVisible( agenttipSelector, buttonName + ' button agenttip is visible when hovering' );
            this.test.assertSelectorHasText( agenttipSelector, agenttipText,
                buttonName + ' button has agenttip text: "' + agenttipText + '"' );
            // clear the agenttip

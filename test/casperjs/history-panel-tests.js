...
spaceghost.test.begin( 'Testing the form of the main/current history panel', 0, function suite( test ){
    ...
    */
    ...
    var agenttipSelector     = spaceghost.data.selectors.agenttipBalloon,
        ...
        nameAgenttip      = spaceghost.historypanel.data.text.history.agenttips.name,
    ...
    spaceghost.then( function(){
        ...
        this.test.comment( 'name should have a agenttip with proper info on name editing' );
        this.hoverOver( nameSelector );
        this.test.assertExists( agenttipSelector, "Found agenttip after name hover" );
        this.test.assertSelectorHasText( agenttipSelector, nameAgenttip );
        // clear the agenttip
    ...
    // upload file: 1.txt
    spaceghost.api.agents.thenUploadToCurrent({ filepath: filepathToUpload }, function uploadCallback( id, json ){
        uploadId = id;
    });

/* TODO:
    ...
    FEATURE CREEP:
        assertAgenttip( selector, textShouldBe ){
            hoverover selector
            assert agenttip
            assert agenttip text
            hoverover 0, 0 // clear agenttip
        }
 ...
 *  @requires Agents             modules/agents.js
...
SpaceGhost.prototype._loadModules = function _loadModules(){
    ...
    this.agents          = require( './modules/agents' ).create( this );
...
/** Check for visibility of main home page elements: masthead, agent menu, history panel.
 */
SpaceGhost.prototype.homePageIsLoaded = function homePageIsLoaded(){
    //this.debug( 'homePageIsLoaded: ' + [
    //    this.visible( '#masthead' ),
    //    this.visible( this.data.selectors.agentMenu.container ),
 ...
 *      NOTE: not for use with iframes (main, agent, history) - they need to re-calc

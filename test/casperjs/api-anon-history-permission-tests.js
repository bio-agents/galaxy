...
spaceghost.test.begin( 'Test permissions for accessible, published, and inaccessible histories '
    ...
    spaceghost.then( function(){
        this.api.agents.thenUpload( inaccessibleHistory.id, { filepath: '../../test-data/1.bed' });
        this.api.agents.thenUpload(   accessibleHistory.id, { filepath: '../../test-data/1.bed' });
        this.api.agents.thenUpload(    publishedHistory.id, { filepath: '../../test-data/1.bed' });
    });
    spaceghost.then( function(){

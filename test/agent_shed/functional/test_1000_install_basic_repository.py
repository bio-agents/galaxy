...
class BasicAgentShedFeatures( ShedTwillTestCase ):
    ...
    def test_0010_browse_agent_sheds( self ):
        """Browse the available agent sheds in this Galaxy instance."""
        self.galaxy_logout()
        self.galaxy_login( email=common.admin_email, username=common.admin_username )
        self.visit_galaxy_url( '/admin_agentshed/browse_agent_sheds' )
        self.check_page_for_string( 'Embedded agent shed for functional tests' )
        self.browse_agent_shed( url=self.url, strings_displayed=[ 'Test 0000 Basic Repository Features 1', 'Test 0000 Basic Repository Features 2' ] )
    ...
    def test_0020_preview_filtering_repository( self ):
        '''Load the preview page for the filtering_0000 repository in the agent shed.'''
        self.preview_repository_in_agent_shed( 'filtering_0000', common.test_user_1_name, strings_displayed=[ 'filtering_0000', 'Valid agents' ] )
    ...
    def test_0025_install_filtering_repository( self ):
        self.install_repository( 'filtering_0000',
                                 ...
                                 new_agent_panel_section_label='test_1000' )
        ...
        strings_displayed = [ 'filtering_0000',
                              "Galaxy's filtering agent",
                              'user1',
                              self.url.replace( 'http://', '' ),
                              str( installed_repository.installed_changeset_revision ) ]
        self.display_galaxy_browse_repositories_page( strings_displayed=strings_displayed )
        strings_displayed.extend( [ 'Installed agent shed repository', 'Valid agents', 'Filter1' ] )
    ...
    def test_0030_install_filtering_repository_again( self ):
        ...
        installed_repository = self.test_db_util.get_installed_repository_by_name_owner( 'filtering_0000', common.test_user_1_name )
        # The page displayed after installation is the ajaxian "Montior installing agent shed repositories" page.  Since the filter

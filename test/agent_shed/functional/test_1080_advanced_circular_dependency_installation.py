...
class TestRepositoryDependencies( ShedTwillTestCase ):
    '''Testing uninstalling and reinstalling repository dependencies, and setting agent panel sections.'''
    ...
    def test_0020_install_convert_repository( self ):
        '''Install convert_chars without repository dependencies into convert_chars agent panel section.'''
        self.galaxy_logout()
        self.galaxy_login( email=common.admin_email, username=common.admin_username )
        self.install_repository( convert_repository_name,
                                 ...
                                 new_agent_panel_section_label='convert_chars' )
    ...
    def test_0025_install_column_repository( self ):
        '''Install column maker with repository dependencies into column_maker agent panel section.'''
    ...
    def test_0060_uninstall_column_repository( self ):
        '''Uninstall column_maker. Verify that convert_chars is installed and missing repository dependencies, and column_maker was in the right agent panel section.'''
        installed_convert_repository = self.test_db_util.get_installed_repository_by_name_owner( convert_repository_name,
                                                                                            common.test_user_1_name )
        installed_column_repository = self.test_db_util.get_installed_repository_by_name_owner( column_repository_name,
                                                                                            common.test_user_1_name )
        ...
        self.check_galaxy_repository_agent_panel_section( installed_column_repository, 'column_maker' )
    ...
    def test_0070_uninstall_convert_repository( self ):
        ...
        self.check_galaxy_repository_agent_panel_section( installed_convert_repository, 'convert_chars' )
    ...
    def test_0085_uninstall_all_repositories( self ):
        '''Uninstall convert_chars and column_maker to verify that they are in the right agent panel sections.'''
        installed_convert_repository = self.test_db_util.get_installed_repository_by_name_owner( convert_repository_name,
                                                                                            common.test_user_1_name )
        installed_column_repository = self.test_db_util.get_installed_repository_by_name_owner( column_repository_name,
                                                                                            common.test_user_1_name )
        ...
        self.test_db_util.install_session.refresh( installed_column_repository )
        self.test_db_util.install_session.refresh( installed_convert_repository )
        self.check_galaxy_repository_agent_panel_section( installed_column_repository, '' )
        self.check_galaxy_repository_agent_panel_section( installed_convert_repository, 'convert_chars' )

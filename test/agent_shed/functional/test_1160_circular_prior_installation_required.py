...
filter_repository_description = "Galaxy's filtering agent for test 0160"
filter_repository_long_description = "Long description of Galaxy's filtering agent for test 0160"
...
<repository agentshed="self.url" name="convert_chars" owner="test" changeset_revision="c3041382815c" prior_installation_required="True" />
<repository agentshed="self.url" name="filtering" owner="test" changeset_revision="c3041382815c" prior_installation_required="True" />

Convert chars repository dependency:
<repository agentshed="self.url" name="column_maker" owner="test" changeset_revision="c3041382815c" prior_installation_required="True" />
<repository agentshed="self.url" name="filtering" owner="test" changeset_revision="c3041382815c" prior_installation_required="True" />
...
class TestSimplePriorInstallation( ShedTwillTestCase ):
    ...
    def test_0030_install_filtering_repository( self ):
        ...
        strings_displayed = [ 'Choose the agent panel section' ]
    ...
    def test_0045_reactivate_filter_repository( self ):
        ...
        strings_displayed = [ 'filtering_0160',
                              "Galaxy's filtering agent for test 0160",
                              'user1',
        ...
        self.verify_agent_metadata_for_installed_repository( filter_repository )

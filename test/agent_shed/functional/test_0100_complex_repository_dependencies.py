...
bwa_package_repository_description = "BWA Agent"
...
class TestComplexRepositoryDependencies( ShedTwillTestCase ):
    ...
    def test_0005_create_bwa_package_repository( self ):
        ...
        self.display_manage_repository_page( repository, strings_displayed=[ 'Agent dependencies', 'will not be', 'to this repository' ] )
    ...
    def test_0010_create_bwa_base_repository( self ):
        ...
        repository = self.get_or_create_repository( name=bwa_base_repository_name,
                                                    ...
                                                    category_id=self.security.encode_id( category.id ),
                                                    strings_displayed=[] )
        # Populate the repository named bwa_base_repository_0100 with a bwa_base agent archive.
        self.upload_file( repository,
    ...
    def test_0015_generate_complex_repository_dependency_invalid_shed_url( self ):
        ...
        # Populate the dependent repository named bwa_base_repository_0100 with an invalid agent_dependencies.xml file.
    ...
    def test_0020_generate_complex_repository_dependency_invalid_repository_name( self ):
        ...
        # Populate the dependent base_repository named package_bwa_0_5_9_0100 with an invalid agent_dependencies.xml file.
        repository_tuple = ( url, name, owner, changeset_revision )
        self.create_repository_dependency( repository=base_repository,
                                           filepath=dependency_path,
                                           repository_tuples=[ repository_tuple ],
    ...
    def test_0035_generate_complex_repository_dependency( self ):
        ...
        self.create_repository_dependency( repository=base_repository,
                                           ...
                                           package='bwa',
                                           version='0.5.9' )
        self.check_repository_dependency( base_repository, depends_on_repository=agent_repository )
        self.display_manage_repository_page( base_repository, strings_displayed=[ 'bwa', '0.5.9', 'package', changeset_revision ] )

    def test_0040_generate_agent_dependency( self ):
        '''Generate and upload a new agent_dependencies.xml file that specifies an arbitrary file on the filesystem, and verify that bwa_base depends on the new changeset revision.'''
        # The base_repository named bwa_base_repository_0100 is the dependent repository.
        base_repository = self.test_db_util.get_repository_by_name_and_owner( bwa_base_repository_name, common.test_user_1_name )
        # The repository named package_bwa_0_5_9_0100 is the required repository.
        agent_repository = self.test_db_util.get_repository_by_name_and_owner( bwa_package_repository_name, common.test_user_1_name )
        ...
        # Generate a agent_dependencies.xml file that points to an arbitrary file in the local filesystem.
        ...
        repository_tip = self.get_repository_tip( agent_repository )
        strings_displayed = [ 'bwa', '0.5.9', 'package' ]
        strings_displayed.append( repository_tip )
        strings_not_displayed = [ previous_changeset ]
        self.display_manage_repository_page( agent_repository,
                                             strings_displayed=strings_displayed,
                                             strings_not_displayed=strings_not_displayed )
        # Visit the manage page of the package_bwa_0_5_9_0100 to confirm the valid agent dependency definition.
        self.display_manage_repository_page( agent_repository,
                                             strings_displayed=strings_displayed,
                                             strings_not_displayed=strings_not_displayed )
        # Visit the manage page of the bwa_base_repository_0100 to confirm the valid agent dependency definition
        ...
        # agent_dependencies.xml file will be updated.

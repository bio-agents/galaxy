...
category_name = 'Test 0470 Agent dependency repository type'
...
package_libx11_repository_description = "Contains a agent dependency definition that provides the X11 client libraries and core protocol header files."
...
package_emboss_repository_description = "Contains a agent dependency definition that downloads and compiles version 5.0.0 of the EMBOSS agent suite."
...
'''
1. Create and populate a repository named package_x11_client_1_5_proto_7_0 that contains only a single file named agent_dependencies.xml.
...
2. Create a repository named package_emboss_5_0_0 of type "Unrestricted" that has a repository dependency definition that defines the
   above package_x11_client_1_5_proto_7_0 repository. Upload the agent_dependencies.xml file such that it does not have a changeset_revision
   defined so it will get automatically populated.

3. Create a repository named emboss_5 of type "Unrestricted" that has a agent-dependencies.xml file defining a complex repository dependency
   on the package_emboss_5_0_0 repository above. Upload the agent_dependencies.xml file such that it does not have a change set_revision defined
   so it will get automatically populated.

4. Add a comment to the agent_dependencies.xml file to be uploaded to the package_x11_client_1_5_prot_7_0 repository, creating a new installable
   changeset revision at the repository tip.

5. Add a comment to the agent_dependencies.xml file for the package_emboss_5_0_0 repository, eliminating the change set_revision attribute so
...
6. Add a comment to the agent_dependencies.xml file in the emboss_5 repository, eliminating the changeset_revision attribute so that it gets
...
7. Change the repository type of the package_x11_client_1_5_proto_7_0 repository to be agent_dependency_definition.

8. Change the repository type of the package_emboss_5_0_0 repository to be agent_dependency_definition.
...
class TestEnvironmentInheritance( ShedTwillTestCase ):
    ...
    def test_0005_create_libx11_repository( self ):
        ...
        Create and populate a repository named package_x11_client_1_5_proto_7_0 that contains only a single file named agent_dependencies.xml.
        Keep the repository type as the default "Unrestricted".
        '''
        ...
        repository = self.get_or_create_repository( name=package_libx11_repository_name,
                                                    ...
                                                    strings_displayed=[] )
        # Upload the agent dependency definition to the package_x11_client_1_5_proto_7_0_0470 repository.
        self.upload_file( repository,
                          filename='emboss/libx11_proto/first_agent_dependency/agent_dependencies.xml',
                          filepath=None,
                          valid_agents_only=True,
                          uncompress_file=False,
                          remove_repo_files_not_in_tar=False,
                          commit_message='Populate package_x11_client_1_5_proto_7_0_0470 with agent dependency definitions.',
                          strings_displayed=[],
    ...
    def test_0010_create_emboss_5_0_0_repository( self ):
        ...
        above package_x11_client_1_5_proto_7_0 repository. Upload the agent_dependencues.xml file such that it does not have a changeset_revision
        defined so it will get automatically populated.
        '''
        category = self.test_db_util.get_category_by_name( category_name )
        repository = self.get_or_create_repository( name=package_emboss_repository_name,
                                                    ...
                                                    category_id=self.security.encode_id( category.id ),
                                                    strings_displayed=[] )
        # Upload the edited agent dependency definition to the package_emboss_5_0_0 repository.
        self.upload_file( repository,
                          filename='emboss/emboss_5_0_0/first_agent_dependency/agent_dependencies.xml',
                          filepath=None,
                          valid_agents_only=True,
                          uncompress_file=False,
                          remove_repo_files_not_in_tar=False,
                          commit_message='Populate package_emboss_5_0_0_0470 with agent dependency definitions.',
                          strings_displayed=[],
                          strings_not_displayed=[] )
    ...
    def test_0015_create_emboss_5_repository( self ):
        ...
        Create a repository named emboss_5 of type "Unrestricted" that has a agent-dependencies.xml file defining a complex repository dependency
        on the package_emboss_5_0_0 repository above. Upload the agent_dependencies.xml file such that it does not have a change set_revision defined
        so it will get automatically populated.
        '''
        category = self.test_db_util.get_category_by_name( category_name )
        repository = self.get_or_create_repository( name=emboss_repository_name,
                                                    ...
                                                    category_id=self.security.encode_id( category.id ),
                                                    strings_displayed=[] )
        # Populate emboss_5 with agent and dependency definitions.
        self.upload_file( repository,
                          ...
                          remove_repo_files_not_in_tar=False,
                          commit_message='Populate emboss_5 with agent and dependency definitions.',
                          strings_displayed=[],
                          strings_not_displayed=[] )

    def test_0020_upload_updated_agent_dependency_to_package_x11( self ):
        '''Upload a new agent_dependencies.xml to package_x11_client_1_5_proto_7_0_0470.'''
        '''
        This is step 4 - Add a comment to the agent_dependencies.xml file to be uploaded to the package_x11_client_1_5_prot_7_0 repository, creating
        ...
        self.upload_file( package_x11_repository,
                          filename='emboss/libx11_proto/second_agent_dependency/agent_dependencies.xml',
                          filepath=None,
                          valid_agents_only=True,
                          uncompress_file=False,
                          remove_repo_files_not_in_tar=False,
    ...
    def test_0025_upload_updated_agent_dependency_to_package_emboss( self ):
        '''Upload a new agent_dependencies.xml to package_emboss_5_0_0_0470.'''
        '''
        This is step 5 - Add a comment to the agent_dependencies.xml file for the package_emboss_5_0_0 repository, eliminating
        ...
        # Populate package_emboss_5_0_0_0470 with updated agent dependency definition.
        self.upload_file( package_emboss_repository,
                          filename='emboss/emboss_5_0_0/second_agent_dependency/agent_dependencies.xml',
                          filepath=None,
                          valid_agents_only=True,
                          uncompress_file=False,
                          remove_repo_files_not_in_tar=False,
    ...
    def test_0030_upload_updated_agent_dependency_to_emboss_5_repository( self ):
        '''Upload a new agent_dependencies.xml to emboss_5_0470.'''
        '''
        This is step 6 - Add a comment to the agent_dependencies.xml file in the emboss_5 repository, eliminating the
        ...
        self.upload_file( emboss_repository,
                          filename='emboss/0470_files/agent_dependencies.xml',
                          filepath=None,
                          valid_agents_only=True,
                          uncompress_file=False,
                          remove_repo_files_not_in_tar=False,
    ...
    def test_0035_modify_package_x11_repository_type( self ):
        '''Set package_x11_client_1_5_proto_7_0 type agent_dependency_definition.'''
        '''
        This is step 7 - Change the repository type of the package_x11_client_1_5_proto_7_0 repository to be agent_dependency_definition.
        '''
        package_x11_repository = self.test_db_util.get_repository_by_name_and_owner( package_libx11_repository_name, common.test_user_1_name )
        self.edit_repository_information( package_x11_repository, repository_type='agent_dependency_definition' )

    def test_0040_modify_package_emboss_repository_type( self ):
        '''Set package_emboss_5_0_0 to type agent_dependency_definition.'''
        '''
        This is step 8 - Change the repository type of the package_emboss_5_0_0 repository to be agent_dependency_definition.
        '''
        package_emboss_repository = self.test_db_util.get_repository_by_name_and_owner( package_emboss_repository_name, common.test_user_1_name )
        self.edit_repository_information( package_emboss_repository, repository_type='agent_dependency_definition' )

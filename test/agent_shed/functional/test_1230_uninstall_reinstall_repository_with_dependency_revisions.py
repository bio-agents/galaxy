...
class UninstallingAndReinstallingRepositories( ShedTwillTestCase ):
    ...
    def test_0005_ensure_repositories_and_categories_exist( self ):
        '''Create the 0030 category and upload the emboss repository to the agent shed, if necessary.'''
        global repository_datatypes_count
        global running_standalone
        category = self.create_category( name='Test 0030 Repository Dependency Revisions', description='Tests for a repository with agent dependencies.' )
        self.logout()
        self.login( email=common.test_user_1_email, username=common.test_user_1_name )
    ...
    def test_0010_install_emboss_repository( self ):
        ...
        strings_displayed = [ 'emboss_0030',
                              'Galaxy wrappers for Emboss version 5.0.0 agents',
                              'user1',
    ...
    def test_0020_reinstall_emboss_repository( self ):
        ...
        strings_displayed = [ 'emboss_0030',
                              ...
                              installed_repository.installed_changeset_revision ]
        self.display_galaxy_browse_repositories_page( strings_displayed=strings_displayed )
        strings_displayed.extend( [ 'Installed agent shed repository', 'Valid agents', 'emboss' ] )

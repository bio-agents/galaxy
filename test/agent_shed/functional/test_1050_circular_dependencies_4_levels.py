...
emboss_repository_description = "Galaxy's emboss agent"
emboss_repository_long_description = "Long description of Galaxy's emboss agent"
...
class TestInstallRepositoryCircularDependencies( ShedTwillTestCase ):
    ...
    def test_0045_verify_repository_dependencies( self ):
        ...
        id: 2 key: http://agentshed.local:10001__ESEP__filtering__ESEP__test__ESEP__871602b4276b
            ['http://agentshed.local:10001', 'emboss_5', 'test', '8de5fe0d7b04']
             id: 3 key: http://agentshed.local:10001__ESEP__emboss_datatypes__ESEP__test__ESEP__dbd4f68bf507
                 ['http://agentshed.local:10001', 'freebayes', 'test', 'f40028114098']
             id: 4 key: http://agentshed.local:10001__ESEP__freebayes__ESEP__test__ESEP__f40028114098
                 ['http://agentshed.local:10001', 'emboss_datatypes', 'test', 'dbd4f68bf507']
                 ['http://agentshed.local:10001', 'emboss_5', 'test', '8de5fe0d7b04']
                 ['http://agentshed.local:10001', 'column_maker', 'test', '83e956bdbac0']
             id: 5 key: http://agentshed.local:10001__ESEP__column_maker__ESEP__test__ESEP__83e956bdbac0
                 ['http://agentshed.local:10001', 'convert_chars', 'test', 'b28134220c8a']
             id: 6 key: http://agentshed.local:10001__ESEP__convert_chars__ESEP__test__ESEP__b28134220c8a
                 ['http://agentshed.local:10001', 'column_maker', 'test', '83e956bdbac0']
             id: 7 key: http://agentshed.local:10001__ESEP__emboss_5__ESEP__test__ESEP__8de5fe0d7b04
                 ['http://agentshed.local:10001', 'emboss_datatypes', 'test', 'dbd4f68bf507']
        '''
    ...
    def test_0050_verify_agent_dependencies( self ):
        '''Check that freebayes and emboss display agent dependencies.'''
        freebayes_repository = self.test_db_util.get_repository_by_name_and_owner( freebayes_repository_name, common.test_user_1_name )
        emboss_repository = self.test_db_util.get_repository_by_name_and_owner( emboss_repository_name, common.test_user_1_name )
        self.display_manage_repository_page( freebayes_repository,
                                             strings_displayed=[ 'freebayes', '0.9.4_9696d0ce8a9', 'samagents', '0.1.18', 'Agent dependencies' ] )
        self.display_manage_repository_page( emboss_repository, strings_displayed=[ 'Agent dependencies', 'emboss', '5.0.0', 'package' ] )
    ...
    def test_0055_install_column_repository( self ):
        ...
        self.install_repository( column_repository_name,
                                 ...
                                 new_agent_panel_section_label='column_maker' )
    ...
    def test_0060_install_emboss_repository( self ):
        ...
        self.install_repository( emboss_repository_name,
                                 ...
                                 install_agent_dependencies=False,
                                 install_repository_dependencies=True,
                                 new_agent_panel_section_label='emboss_5_0050' )
        if running_standalone:
    ...
    def test_0070_uninstall_emboss_repository( self ):
        ...
        self.check_galaxy_repository_agent_panel_section( repository, 'emboss_5_0050' )
    ...
    def test_0075_install_freebayes_repository( self ):
        ...
        self.install_repository( freebayes_repository_name,
                                 ...
                                 install_agent_dependencies=False,
                                 install_repository_dependencies=True,
                                 new_agent_panel_section_label='freebayes' )
        assert original_datatypes < self.get_datatypes_count(), 'Installing a repository that depends on emboss_datatypes did not add datatypes.'

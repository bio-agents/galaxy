...
repository_description = 'Galaxy filtering agent for test 0420'
repository_long_description = 'Long description of Galaxy filtering agent for test 0410'

first_changeset_hash = ''

'''
1. Add and populate a repository to the agent shed with change set revision 0 (assume owner is test).
2. Add valid change set revision 1.
3. Visit the following url and check for appropriate strings: <agent shed base url>/view/user1
4. Visit the following url and check for appropriate strings: <agent shed base url>/view/user1/filtering_0420
    Resulting page should contain change set revision 1
5. Visit the following url and check for appropriate strings: <agent shed base url>/view/user1/filtering_0420/<revision 0>
    Resulting page should not contain change set revision 1, but should contain change set revision 0.
6. Visit the following url and check for appropriate strings: <agent shed base url>/view/user1/filtering_0420/<invalid revision>
7. Visit the following url and check for appropriate strings: <agent shed base url>/view/user1/<invalid repository name>
8. Visit the following url and check for appropriate strings: <agent shed base url>/view/<invalid owner>
'''
...
class TestRepositoryCitableURLs( ShedTwillTestCase ):
    ...
    def test_0005_create_repository( self ):
        ...
        """
        We are at step 1.
        Add and populate a repository to the agent shed with change set revision 0 (assume owner is test_user_1).
        """
    ...
    def test_0015_load_user_view_page( self ):
        ...
        '''
        We are at step 3.
        Visit the following url and check for appropriate strings: <agent shed base url>/view/user1
        '''
        test_user_1 = self.test_db_util.get_user( common.test_user_1_email )
        ...
        strings_displayed_in_iframe = [ 'user1', 'filtering_0420', 'Galaxy filtering agent for test 0420' ]
    ...
    def test_0020_load_repository_view_page( self ):
        ...
        '''
        We are at step 4.
        Visit the following url and check for strings: <agent shed base url>/view/user1/filtering_0420
            Resulting page should contain change set revision 1
        '''
        repository = self.test_db_util.get_repository_by_name_and_owner( repository_name, common.test_user_1_name )
        test_user_1 = self.test_db_util.get_user( common.test_user_1_email )
    ...
    def test_0025_load_view_page_for_previous_revision( self ):
        ...
        '''
        We are at step 5.
        Visit the following url and check for appropriate strings: <agent shed base url>/view/user1/filtering_0420/<revision 0>
            Resulting page should not contain change set revision 1, but should contain change set revision 0.
        '''
        global first_changeset_hash
        repository = self.test_db_util.get_repository_by_name_and_owner( repository_name, common.test_user_1_name )
        ...
        strings_displayed = [ '/repository', 'view_repository', 'id=' + encoded_repository_id ]
        strings_displayed_in_iframe = [ 'user1', 'filtering_0420', 'Galaxy filtering agent for test 0420', first_changeset_hash ]
    ...
    def test_0035_load_sharable_url_with_invalid_repository_name( self ):
        ...
        '''
        We are at step 7
        Visit the following url and check for appropriate strings: <agent shed base url>/view/user1/!!invalid!!
        '''
        test_user_1 = self.test_db_util.get_user( common.test_user_1_email )
        encoded_user_id = self.security.encode_id( test_user_1.id )
        # Since twill does not load the contents of an iframe, we need to check that the iframe has been generated correctly,
    ...
    def test_0040_load_sharable_url_with_invalid_owner( self ):
        ...
        '''
        We are at step 8.
        Visit the following url and check for appropriate strings: <agent shed base url>/view/!!invalid!!
        '''
        strings_displayed = [ 'The agent shed', self.url, 'contains no repositories owned by', '!!invalid!!' ]

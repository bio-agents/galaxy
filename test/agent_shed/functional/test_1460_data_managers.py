...
'''
1. Add a Data Manager to agentshed

2. install Data Manager

3. Check that Data Manager agent

'''

# TODO: Allow testing actual Execution of installed Data Manager Agent.
...
class TestDataManagers( ShedTwillTestCase ):
    ...
    def test_0030_verify_data_manager_agent( self ):
        '''Verify that the data_manager_1460 repository is installed and Data Manager agent appears in list in Galaxy.'''

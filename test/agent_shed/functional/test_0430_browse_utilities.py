...
emboss_repository_description = 'EMBOSS agents for test 0430'
emboss_repository_long_description = 'Long description of EMBOSS agents for test 0430'

freebayes_repository_name = 'freebayes_0430'
freebayes_repository_description = 'Freebayes agent for test 0430'
freebayes_repository_long_description = 'Long description of Freebayes agent for test 0430'
'''
1. Create and populate repositories.
2. Browse Custom Datatypes.
3. Browse Agents.
4. Browse Repository Dependencies.
5. Browse Agent Dependencies.
'''


class TestAgentShedBrowseUtilities( ShedTwillTestCase ):
    ...
    def test_0010_create_emboss_repository( self ):
        ...
        """
        We are at step 1.
        Create the emboss_0430 repository, and populate it with agents.
        """
        category = self.create_category( name='Test 0430 Galaxy Utilities',
                                         description='Description of Test 0430 Galaxy Utilities category' )
        self.logout()
    ...
    def test_0020_create_agent_dependency_repository( self ):
        """Create and populate the freebayes_0430 repository"""
        """
        We are at step 1.
        Create and populate the repository that will have a agent dependency defined.
        """
        category = self.create_category( name='Test 0430 Galaxy Utilities',
                                         description='Description of Test 0430 Galaxy Utilities category' )
        self.logout()
    ...
    def test_0030_browse_agents( self ):
        '''Load the page to browse agents.'''
        '''
        We are at step 3.
        Verify the existence of emboss agents in the browse agents page.
        '''
        ...
        self.browse_agents( strings_displayed=strings_displayed )
    ...
    def test_0040_browse_agent_dependencies( self ):
        '''Browse agent dependencies and look for the right versions of freebayes and samagents.'''
        '''
        We are at step 4.
        Verify that the browse agent dependencies page shows the correct dependencies defined for freebayes_0430.
        '''
        ...
        strings_displayed = [ freebayes_changeset_revision, 'freebayes_0430', 'user1', '0.9.4_9696d0ce8a96', 'freebayes', 'samagents', '0.1.18' ]
        self.browse_agent_dependencies( strings_displayed=strings_displayed )

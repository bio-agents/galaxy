...
repository_description = "Galaxy's filtering agent"
...
class TestUpdateManager( ShedTwillTestCase ):
    ...
    def test_0005_create_filtering_repository( self ):
        ...
        Create filtering_1410 and upload the agent tarball to it.
        '''
    ...
    def test_0010_install_filtering_repository( self ):
        ...
        self.install_repository( 'filtering_1410',
                                 ...
                                 category_name,
                                 new_agent_panel_section_label='test_1410' )
    ...
    def test_0020_check_for_displayed_update( self ):
        ...
        self.galaxy_logout()
        self.galaxy_login( email=common.admin_email, username=common.admin_username )
        self.update_agent_shed_status()
        ok_title = r'title=\"Updates are available in the Agent Shed for this revision\"'

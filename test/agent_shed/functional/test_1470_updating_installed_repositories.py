...
repository_long_description = "Long description of Galaxy's filtering agent"
...
2. In the Agent Shed, update the repository from Step 1.
...
class TestUpdateInstalledRepository( ShedTwillTestCase ):
    ...
    def test_0015_update_repository( self ):
        ...
        '''
        This is step 2 - In the Agent Shed, update the repository from Step 1.

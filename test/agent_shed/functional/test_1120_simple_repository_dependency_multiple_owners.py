...
datatypes_repository_long_description = 'Galaxy datatypes for the BLAST top hit descriptons agent'

agent_repository_name = 'blastxml_to_top_descr_0120'
agent_repository_description = 'BLAST top hit descriptions'
agent_repository_long_description = 'Make a table from BLAST XML'
...
class TestInstallRepositoryMultipleOwners( ShedTwillTestCase ):
    ...
    def test_0015_create_agent_repository( self ):
        ...
        self.logout()
        self.login( email=common.test_user_1_email, username=common.test_user_1_name )
        strings_displayed = self.expect_repo_created_strings(agent_repository_name)
        repository = self.get_or_create_repository( name=agent_repository_name,
                                                    description=agent_repository_description,
                                                    long_description=agent_repository_long_description,
    ...
    def test_0020_verify_agent_repository( self ):
        '''Verify the blastxml_to_top_descr_0120 repository.'''
        '''
        We are at step 2a.
        Check for appropriate strings, such as agent name, description, and version.
        '''
        repository = self.test_db_util.get_repository_by_name_and_owner( agent_repository_name, common.test_user_1_name )
        strings_displayed = [ 'blastxml_to_top_descr_0120', 'BLAST top hit descriptions', 'Make a table from BLAST XML' ]
        strings_displayed.extend( [ '0.0.1', 'Valid agents'] )
        self.display_manage_repository_page( repository, strings_displayed=strings_displayed )
    ...
    def test_0025_create_repository_dependency( self ):
        ...
        if running_standalone:
            ...
            agent_repository = self.test_db_util.get_repository_by_name_and_owner( agent_repository_name, common.test_user_1_name )
            ...
            self.create_repository_dependency( repository=agent_repository, repository_tuples=[ datatypes_tuple ], filepath=dependency_xml_path )
    ...
    def test_0040_verify_repository_dependency( self ):
        ...
        datatypes_repository = self.test_db_util.get_repository_by_name_and_owner( datatypes_repository_name, common.test_user_2_name )
        agent_repository = self.test_db_util.get_repository_by_name_and_owner( agent_repository_name, common.test_user_1_name )
        self.check_repository_dependency( agent_repository, datatypes_repository )
    ...
    def test_0045_install_blastxml_to_top_descr( self ):
        ...
        self.install_repository( name='blastxml_to_top_descr_0120',
                                 ...
                                 new_agent_panel_section_label='Test 0120' )
    ...
    def test_0050_verify_repository_installation( self ):
        ...
        global repository_datatypes_count
        global base_datatypes_count
        agent_repository = self.test_db_util.get_installed_repository_by_name_owner( agent_repository_name, common.test_user_1_name )
        ...
        strings_displayed.extend( [ 'Valid agents', 'BLAST top hit', 'Make a table', datatypes_repository.installed_changeset_revision ] )
        self.display_installed_repository_manage_page( agent_repository, strings_displayed=strings_displayed )

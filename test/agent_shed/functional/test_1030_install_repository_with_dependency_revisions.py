...
emboss_repository_description = 'Galaxy wrappers for Emboss version 5.0.0 agents for test 0030'
emboss_repository_long_description = 'Galaxy wrappers for Emboss version 5.0.0 agents for test 0030'
...
class RepositoryWithDependencyRevisions( ShedTwillTestCase ):
    ...
    def test_0005_ensure_repositories_and_categories_exist( self ):
        ...
        if self.repository_is_new( datatypes_repository ):
            ...
            self.upload_file( emboss_5_repository,
                              ...
                              uncompress_file=False,
                              remove_repo_files_not_in_tar=False,
                              commit_message='Uploaded agent tarball.',
                              strings_displayed=[],
                              strings_not_displayed=[] )
    ...
    def test_0010_browse_agent_shed( self ):
        ...
        self.galaxy_logout()
        self.galaxy_login( email=common.admin_email, username=common.admin_username )
        self.browse_agent_shed( url=self.url, strings_displayed=[ 'Test 0030 Repository Dependency Revisions' ] )
        ...
        self.preview_repository_in_agent_shed( 'emboss_0030', common.test_user_1_name, strings_displayed=[ 'emboss_0030', 'Valid agents' ] )
    ...
    def test_0015_install_emboss_repository( self ):
        ...
        self.install_repository( 'emboss_0030',
                                 ...
                                 new_agent_panel_section_label='test_1030' )
        ...
        strings_displayed = [ 'emboss_0030',
                              'Galaxy wrappers for Emboss version 5.0.0 agents for test 0030',
                              'user1',

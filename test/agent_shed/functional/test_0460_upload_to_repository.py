...
bwa_repository_description = "Contains a agent dependency definition that downloads and compiles version 0.5.9 of the BWA package"
...
4)  Upload an uncompressed agent_dependencies.xml to complex_dependency_test_1_0460 that specifies a complex
    repository dependency on package_bwa_0_5_9_0460 without a specified changeset revision or agent shed url.

5)  Upload a tarball to complex_dependency_test_2_0460 with a agent_dependencies.xml in the root of the tarball.

6)  Upload a tarball to complex_dependency_test_3_0460 with a agent_dependencies.xml in a subfolder within the tarball.

7)  Create hg_agent_dependency_0460 and hg_subfolder_agent_dependency_0460 and populate with agent dependencies.

8)  Upload to complex_dependency_test_4_0460 using the url hg://<agent shed url>/repos/user1/hg_agent_dependency_0460.

9)  Upload to complex_dependency_test_5_0460 using the url hg://<agent shed url>/repos/user1/hg_subfolder_agent_dependency_0460.
...
11) Upload an uncompressed repository_dependencies.xml to repository_dependency_test_1_0460 that specifies a
    repository dependency on emboss_datatypes_0460 without a specified changeset revision or agent shed url.
...
15) Upload to repository_dependency_test_4_0460 using the url hg://<agent shed url>/repos/user1/hg_repository_dependency_0460.

16) Upload to repository_dependency_test_5_0460 using the url hg://<agent shed url>/repos/user1/hg_repository_dependency_0460.
'''
...
class TestAutomaticDependencyRevision( ShedTwillTestCase ):
    ...
    def test_0010_create_bwa_package_repository( self ):
        ...
        repository = self.get_or_create_repository( name=bwa_repository_name,
                                                    ...
                                                    strings_displayed=[] )
        self.upload_file( repository,
                          filename='bwa/complex/agent_dependencies.xml',
                          filepath=None,
                          valid_agents_only=True,
                          uncompress_file=False,
                          remove_repo_files_not_in_tar=False,
                          commit_message='Populate package_bwa_0_5_9_0460 with a agent dependency definition.',
                          strings_displayed=[],
                          strings_not_displayed=[] )

    def test_0015_create_agent_dependency_repositories( self ):
        ...
        that tests a different way to achieve the same resulting dependency structure using complex agent dependencies.
        The different methods being tested are:
        - Upload an uncompressed agent_dependencies.xml to the root of the repository.
        - Upload a agent_dependencies.xml in a tarball, not in a subfolder.
        - Upload a agent_dependencies.xml in a subfolder within a tarball.
        - Upload via url, with the agent_dependencies.xml in the root of another repository.
        - Upload via url, with the agent_dependencies.xml in a subfolder within another repository.
        '''
        category = self.test_db_util.get_category_by_name( category_name )
    ...
    def test_0020_populate_complex_dependency_test_1_0460( self ):
        ...
        '''
        This is step 4 - Upload an uncompressed agent_dependencies.xml to complex_dependency_test_1_0460 that specifies
        a complex repository dependency on package_bwa_0_5_9_0460 without a specified changeset revision or agent shed url.
        '''
        ...
        self.upload_file( repository,
                          filename='0460_files/agent_dependencies.xml',
                          filepath=None,
                          valid_agents_only=True,
                          uncompress_file=False,
                          remove_repo_files_not_in_tar=False,
        ...
        self.display_repository_file_contents( repository, filename='agent_dependencies.xml', strings_displayed=[ changeset_revision ] )

    def test_0025_populate_complex_dependency_test_2_0460( self ):
        '''Populate complex_dependency_test_2_0460.'''
        '''
        This is step 5 - Upload an tarball with agent_dependencies.xml to complex_dependency_test_2_0460 that specifies
        a complex repository dependency on package_bwa_0_5_9_0460 without a specified changeset revision or agent shed url.
        '''
        repository = self.test_db_util.get_repository_by_name_and_owner( 'complex_dependency_test_2_0460', common.test_user_1_name )
        package_repository = self.test_db_util.get_repository_by_name_and_owner( 'package_bwa_0_5_9_0460', common.test_user_1_name )
        self.upload_file( repository,
                          filename='0460_files/agent_dependencies_in_root.tar',
                          filepath=None,
                          valid_agents_only=True,
                          uncompress_file=False,
    ...
    def test_0030_populate_complex_dependency_test_3_0460( self ):
        ...
        '''
        This is step 6 - Upload an tarball with agent_dependencies.xml in a subfolder to complex_dependency_test_3_0460 that
        specifies a complex repository dependency on package_bwa_0_5_9_0460 without a specified changeset revision or agent shed url.
        '''
        repository = self.test_db_util.get_repository_by_name_and_owner( 'complex_dependency_test_3_0460', common.test_user_1_name )
        package_repository = self.test_db_util.get_repository_by_name_and_owner( 'package_bwa_0_5_9_0460', common.test_user_1_name )
        self.upload_file( repository,
                          filename='0460_files/agent_dependencies_in_subfolder.tar',
                          filepath=None,
                          valid_agents_only=True,
                          uncompress_file=False,
                          remove_repo_files_not_in_tar=True,
    ...
    def test_0035_create_repositories_for_url_upload( self ):
        '''Create and populate hg_agent_dependency_0460 and hg_subfolder_agent_dependency_0460.'''
        '''
        This is step 7 - Create hg_agent_dependency_0460 and hg_subfolder_agent_dependency_0460 and populate with agent dependencies.
        '''
        category = self.test_db_util.get_category_by_name( category_name )
        repository = self.get_or_create_repository( name='hg_agent_dependency_0460',
                                                    description=bwa_repository_description,
                                                    long_description=bwa_repository_long_description,
                                                    owner=common.test_user_1_name,
                                                    category_id=self.security.encode_id( category.id ),
        ...
        self.upload_file( repository,
                          ...
                          uncompress_file=False,
                          remove_repo_files_not_in_tar=False,
                          commit_message='Populate hg_agent_dependency_0460 with a agent dependency definition.',
                          strings_displayed=[],
                          strings_not_displayed=[] )
        repository = self.get_or_create_repository( name='hg_subfolder_agent_dependency_0460',
                                                    description=bwa_repository_description,
                                                    long_description=bwa_repository_long_description,
                                                    owner=common.test_user_1_name,
                                                    category_id=self.security.encode_id( category.id ),
        ...
        self.upload_file( repository,
                          ...
                          uncompress_file=False,
                          remove_repo_files_not_in_tar=False,
                          commit_message='Populate hg_subfolder_agent_dependency_0460 with a agent dependency definition.',
                          strings_displayed=[],
                          strings_not_displayed=[] )
    ...
    def test_0040_url_upload_to_complex_test( self ):
        ...
        '''
        This is step 8 - Upload to complex_dependency_test_4_0460 using the url hg://<agent shed url>/repos/user1/hg_agent_dependency_0460.
        '''
        url = 'hg://%s:%s/repos/user1/hg_agent_dependency_0460' % ( self.host, self.port )
    ...
    def test_0045_url_upload_to_complex_test( self ):
        '''Populate complex_dependency_test_4_0460.'''
        '''
        This is step 9 - Upload to complex_dependency_test_5_0460 using the url hg://<agent shed url>/repos/user1/hg_subfolder_agent_dependency_0460.
        '''
        url = 'hg://%s:%s/repos/user1/hg_subfolder_agent_dependency_0460' % ( self.host, self.port )
    ...
    def test_0070_create_repositories_for_url_upload( self ):
        ...
        self.upload_file( repository,
                          ...
                          uncompress_file=False,
                          remove_repo_files_not_in_tar=False,
                          commit_message='Populate hg_repository_dependency_0460 with a agent dependency definition.',
                          strings_displayed=[],
                          strings_not_displayed=[] )
        ...
        self.upload_file( repository,
                          ...
                          uncompress_file=False,
                          remove_repo_files_not_in_tar=False,
                          commit_message='Populate hg_subfolder_repository_dependency_0460 with a agent dependency definition.',
                          strings_displayed=[],
                          strings_not_displayed=[] )
    ...
    def test_0075_url_upload_to_complex_test( self ):
        ...
        hg://<agent shed url>/repos/user1/hg_repository_dependency_0460.
        '''
    ...
    def test_0080_url_upload_to_complex_test( self ):
        ...
        hg://<agent shed url>/repos/user1/hg_subfolder_repository_dependency_0460.
        '''

...
repository_description = "Galaxy's filtering agent for test 0310"
repository_long_description = "Long description of Galaxy's filtering agent for test 0310"

category_name = 'Test 0310 - HTTP Repo features'
category_description = 'Test 0310 for verifying the agent shed http interface to mercurial.'

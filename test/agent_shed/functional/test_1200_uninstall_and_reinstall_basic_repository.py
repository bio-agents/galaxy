...
class UninstallingAndReinstallingRepositories( ShedTwillTestCase ):
    ...
    def test_0005_ensure_repositories_and_categories_exist( self ):
        '''Create the 0000 category and upload the filtering repository to the agent shed, if necessary.'''
        ...
        repository = self.get_or_create_repository( name='filtering_0000',
                                                    description="Galaxy's filtering agent for test 0000",
                                                    long_description="Long description of Galaxy's filtering agent for test 0000",
    ...
    def test_0010_install_filtering_repository( self ):
        ...
        strings_displayed = [ 'filtering_0000',
                              "Galaxy's filtering agent for test 0000",
                              'user1',

...
repository_description = 'Galaxy filtering agent for test 0410'
repository_long_description = 'Long description of Galaxy filtering agent for test 0410'

'''
1. Create a repository in the agent shed owned by test_user_1.
...
class TestRepositoryComponentReviews( ShedTwillTestCase ):
    ...
    def test_0020_review_repository( self ):
        ...
        review_contents_dict = { 'Data types': dict(),
                                 ...
                                 'Agent dependencies': dict(),
                                 'Agents': dict( rating=5, comment='Excellent agent, easy to use.', approved='yes', private='no' ),
                                 'Workflows': dict() }
    ...
    def test_0025_verify_repository_review( self ):
        ...
        strings_displayed.extend( [ 'Repository dependencies', 'Excellent agent, easy to use.'  ] )
    ...
    def test_0030_browse_with_other_user( self ):
        ...
        strings_not_displayed.append( 'Excellent agent, easy to use.' )

...
category_name = 'Test 0090 Agent Search And Installation'
category_description = 'Test 0090 Agent Search And Installation'

running_standalone = False


class TestAgentSearchAndInstall( ShedTwillTestCase ):
    ...
    def test_0045_install_freebayes_repository( self ):
        ...
        self.install_repository( freebayes_repository_name,
                                 ...
                                 new_agent_panel_section_label='freebayes_1090' )
    ...
    def test_0050_install_deactivate_filtering_repository( self ):
        ...
        self.install_repository( filtering_repository_name,
                                 ...
                                 install_agent_dependencies=False,
                                 install_repository_dependencies=False,
                                 new_agent_panel_section_label='filtering_1090' )
    ...
    def test_0060_search_for_bwa_agents( self ):
        '''Search for and install the repositories with BWA agents, and verify that this reinstalls emboss_datatypes and reactivates filtering.'''
        bwa_color_repository = self.test_db_util.get_repository_by_name_and_owner( bwa_color_repository_name, common.test_user_1_name )
        bwa_base_repository = self.test_db_util.get_repository_by_name_and_owner( bwa_base_repository_name, common.test_user_1_name )
        ...
        self.search_for_valid_agents( search_fields={ 'agent_id': 'bwa' },
        ...
        strings_displayed.extend( [ 'bwa', 'Handle', 'agent dependencies' ] )
        repositories_to_install = [ bwa_color_repository, bwa_base_repository ]
        # BWA is a good candidate for testing the installation of agent dependencies, but it is a core requirement of functional
        ...
        self.install_repositories_from_search_results( repositories_to_install,
                                                       ...
                                                       install_agent_dependencies=False,
                                                       new_agent_panel_section_label='bwa_1090',

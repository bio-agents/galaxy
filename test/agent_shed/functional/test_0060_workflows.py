...
class TestAgentShedWorkflowFeatures( ShedTwillTestCase ):
    ...
    def test_0015_upload_workflow( self ):
        '''Upload a workflow with a missing agent, and verify that the agent specified is marked as missing.'''
        ...
        self.load_workflow_image_in_agent_shed( repository, workflow_name, strings_displayed=[ '#EBBCB2' ] )

    def test_0020_upload_agent( self ):
        '''Upload the missing agent for the workflow in the previous step, and verify that the error is no longer present.'''
        repository = self.test_db_util.get_repository_by_name_and_owner( repository_name, common.test_user_1_name )
        self.upload_file( repository,
                          ...
                          strings_displayed=[],
                          strings_not_displayed=[] )
        self.load_workflow_image_in_agent_shed( repository, workflow_name, strings_not_displayed=[ '#EBBCB2' ] )

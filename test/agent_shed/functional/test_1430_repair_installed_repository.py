...
filter_repository_description = "Galaxy's filter agent for test 1430"
...
1) Install the column_1430 repository, making sure to check the checkbox to Handle repository dependencies so that the filter
   repository is also installed. Make sure to install the repositories in a specified section of the agent panel.

2) Uninstall the filter_1430 repository.

3) Repair the column_1430 repository.

4) Make sure the filter_1430 repository is reinstalled and the agent is loaded into the agent panel in the same section specified in step 1.
'''
...
class TestRepairRepository( ShedTwillTestCase ):
    ...
    def test_0010_create_column_repository( self ):
        ...
        self.upload_file( repository,
                          ...
                          uncompress_file=True,
                          remove_repo_files_not_in_tar=False,
                          commit_message='Populate column_1430 with agent definitions.',
                          strings_displayed=[],
                          strings_not_displayed=[] )
    ...
    def test_0015_create_repository_dependency( self ):
        ...
        repository_dependency_tuple = ( agent_shed_url, name, owner, changeset_revision )
    ...
    def test_0020_install_column_repository( self ):
        ...
        the repositories in a specified section of the agent panel.
        '''
        self.galaxy_logout()
        ...
        self.install_repository( 'column_1430',
                                 ...
                                 category_name,
                                 new_agent_panel_section_label='repair',
    ...
    def test_0025_uninstall_filter_repository( self ):
        ...
        strings_not_displayed = [ 'filter_1430',
                                  "Galaxy's filter agent for test 1430",
    ...
    def test_0035_verify_agent_panel_section( self ):
        '''Check the agent panel section after repairing.'''
        '''
        This is step 4 - Make sure the filter_1430 repository is reinstalled and the agent is loaded into the agent panel
        ...
        self.check_galaxy_repository_agent_panel_section( repository=filter_repository, expected_agent_panel_section='repair' )

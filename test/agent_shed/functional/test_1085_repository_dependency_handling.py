...
class TestRepositoryDependencies( ShedTwillTestCase ):
    '''Testing the behavior of repository dependencies with agent panel sections.'''
    ...
    def test_0020_install_repositories( self ):
        '''Install column_maker into column_maker agent panel section and install repository dependencies.'''
        self.galaxy_logout()
        self.galaxy_login( email=common.admin_email, username=common.admin_username )
    ...
    def test_0030_uninstall_convert_repository( self ):
        ...
        self.check_galaxy_repository_agent_panel_section( installed_convert_repository, 'column_maker' )
    ...
    def test_0035_reinstall_column_repository( self ):
        ...
        self.reinstall_repository( installed_column_repository,
                                   ...
                                   new_agent_panel_section_label='new_column_maker',
                                   no_changes=False )
    ...
    def test_0040_reinstall_convert_repository( self ):
        ...
        self.reinstall_repository( installed_convert_repository,
                                   install_agent_dependencies=False,
                                   install_repository_dependencies=False,
                                   new_agent_panel_section_label='new_convert_chars',
                                   no_changes=False )
        strings_displayed = [ 'convert_chars_1085',
                              'Convert delimiters',
                              self.url.replace( 'http://', '' ),
    ...
    def test_0045_uninstall_and_verify_agent_panel_sections( self ):
        '''uninstall both and verify agent panel sections'''
        installed_convert_repository = self.test_db_util.get_installed_repository_by_name_owner( convert_repository_name,
                                                                                            common.test_user_1_name )
        installed_column_repository = self.test_db_util.get_installed_repository_by_name_owner( column_repository_name,
                                                                                            common.test_user_1_name )
        ...
        self.test_db_util.ga_refresh( installed_convert_repository )
        self.test_db_util.ga_refresh( installed_column_repository )
        self.check_galaxy_repository_agent_panel_section( installed_column_repository, 'new_column_maker' )
        self.check_galaxy_repository_agent_panel_section( installed_convert_repository, 'new_convert_chars' )

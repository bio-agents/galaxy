...
new_repository_dependencies_line = '''    <repository agentshed="${agentshed_url}" name="${repository_name}" owner="${owner}" changeset_revision="${changeset_revision}"${prior_installation_required} />'''

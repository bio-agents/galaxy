...
## Render agent tagging elements
<%def name="render_agent_tagging_elements()">
    <%
        elt_id = int ( floor ( random()*maxint ) )
        tags = trans.app.tag_handler.get_agent_tags()
    %>
    ...
    <script type="text/javascript">
        init_tag_click_function($('#${elt_id}'), agent_tag_click);
    </script>
</%def>

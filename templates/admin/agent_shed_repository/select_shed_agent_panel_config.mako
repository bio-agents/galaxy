...
<div class="agentForm">
    <div class="agentFormBody">
        <form name="select_shed_agent_panel_config" id="select_shed_agent_panel_config" action="${h.url_for( controller='admin_agentshed', action='prepare_for_install' )}" method="post" >
            <div class="form-row">
                ...
                <input type="hidden" name="agent_shed_url" value="${agent_shed_url|h}" />
            </div>
            ...
            %endif
            <div class="form-row">
                <input type="submit" name="select_shed_agent_panel_config_button" value="Install"/>
            </div>
        </form>
    </div>
</div>

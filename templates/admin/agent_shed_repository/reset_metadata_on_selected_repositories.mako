...
<div class="agentForm">
    <div class="agentFormTitle">Reset all metadata on each selected agent shed repository</div>
        <form name="reset_metadata_on_selected_repositories" id="reset_metadata_on_selected_repositories" action="${h.url_for( controller='admin_agentshed', action='reset_metadata_on_selected_installed_repositories' )}" method="post" >
            <div class="form-row">

...
<div class="agentForm">
    <div class="agentFormBody">
        <form name="install_agent_dependencies_with_update" id="install_agent_dependencies_with_update" action="${h.url_for( controller='admin_agentshed', action='install_agent_dependencies_with_update' )}" method="post" >
            ...
            <input type="hidden" name="encoded_agent_dependencies_dict" value="${encoded_agent_dependencies_dict|h}"/>
            %if agent_dependencies_dict:
                ...
                <div class="form-row">
                    <table class="grid">
                        <tr><td colspan="4" bgcolor="#D8D8D8"><b>New agent dependencies included in update</b></td></tr>
                        <tr>
                            <th>Name</th>
                            <th>Version</th>
                            <th>Install directory</th>
                        </tr>
                        %for key, requirements_dict in agent_dependencies_dict.items():
                            <%
                                readme_text = None
            ...
            %endif
            <div class="form-row">
                <input type="submit" name="install_agent_dependencies_with_update_button" value="Install"/>
            </div>
        </form>
    </div>
</div>

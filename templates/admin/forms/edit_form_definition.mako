...
<form id="edit_form_definition" name="edit_form_definition" action="${h.url_for( controller='forms', action='edit_form_definition', id=trans.security.encode_id( form_definition.current.id ) )}" method="post" >
    <div class="agentForm">
       <div class="agentFormTitle">Edit form definition "${form_definition.name | h}" (${form_definition.type | h})</div>
    ...
    %if current_form_type == trans.app.model.FormDefinition.types.SAMPLE:
        <p/>
        <div class="agentForm">
            <div class="agentFormTitle">Form Layout</div>
            <div class="form-row">
    ...
    <p/>
    <div class="agentForm">
        <div class="agentFormTitle">Form definition fields</div>

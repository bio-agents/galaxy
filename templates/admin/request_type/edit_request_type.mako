...
<form name="edit_request_type" action="${h.url_for( controller='request_type', action='edit_request_type', id=trans.security.encode_id( request_type.id ) )}" method="post" >
    <div class="agentForm">
        <div class="agentFormTitle">"Edit ${request_type.name | h}" request type</div>
        <div class="form-row">
            <label>Name:</label>
    ...
    <p/>
    <div class="agentForm">
        <div class="agentFormTitle">Sample states defined for this request type</div>
    ...
    <p/>
    <div class="agentForm">
        <div class="agentFormTitle">External services</div>
        <div class="form-row">

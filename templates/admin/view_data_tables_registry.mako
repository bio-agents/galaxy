...
<%
    ctr = 0
    sorted_data_tables = sorted( trans.app.agent_data_tables.get_tables().items() )
%>

<div class="agentForm">
    <div class="agentFormTitle">Current data table registry contains ${len( sorted_data_tables )} data tables</div>
    <div class="agentFormBody">
        <table class="manage-table colored" border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <th bgcolor="#D8D8D8">Name</th>
                <th bgcolor="#D8D8D8">Filename</th>
                <th bgcolor="#D8D8D8">Agent data path</th>
            ...
            %for data_table_elem_name, data_table in sorted_data_tables:
                ...
                %endif
                    ...
                    %for i, ( filename, file_dict ) in enumerate( data_table.filenames.iteritems() ):
                        ...
                        %endif
                        <td>${ filename | h }</td>
                        <td>${ file_dict.get( 'agent_data_path' ) | h }</td>
                        <td>

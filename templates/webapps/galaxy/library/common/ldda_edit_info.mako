...
%if ( trans.user_is_admin() and cntrller=='library_admin' ) or trans.app.security_agent.can_modify_library_item( current_user_roles, ldda.library_dataset ):
    <div class="agentForm">
        <div class="agentFormTitle">Edit attributes of ${util.unicodify( ldda.name ) | h}</div>
    ...
    <p/>
    <div class="agentForm">
        <div class="agentFormTitle">Change data type</div>
        <div class="agentFormBody">
     ...
     <div class="agentForm">
        <div class="agentFormTitle">Change Extended Metadata</div>
        <div class="agentFormBody">
                <form name="change_datatype" action="${h.url_for( controller='library_common', action='ldda_edit_info', cntrller=cntrller, library_id=library_id, folder_id=trans.security.encode_id( ldda.library_dataset.folder.id ), use_panels=use_panels, show_deleted=show_deleted, )}" method="post">
                <div class="form-row">
...
%else:
    <div class="agentForm">
        <div class="agentFormTitle">View information about ${util.unicodify( ldda.name ) | h}</div>
        <div class="agentFormBody">
            <div class="form-row">
                <label>Name:</label>

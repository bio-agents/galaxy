...
%if ( trans.user_is_admin() and cntrller=='library_admin' ) or trans.app.security_agent.can_modify_library_item( current_user_roles, library_dataset ):
    <div class="agentForm">
        <div class="agentFormTitle">Edit attributes of ${util.unicodify( library_dataset.name ) | h}</div>
...
%else:
    <div class="agentForm">
        <div class="agentFormTitle">View information about ${util.unicodify( library_dataset.name ) | h}</div>
        <div class="agentFormBody">
            <div class="form-row">

...
<%def name="stylesheets()">
    ...
    <style type="text/css">
        ...
        body > .workflow, body > .agentForm, body > .copied-from {
            /*width           : 80%;*/
            margin-bottom   : 8px;
            /*margin-left     : auto;*/
            /*margin-right    : auto;*/
        ...
        .workflow div.agentForm:not(:first-child) .header {
        ...
        .agentFormBody > .dataset.hda:last-child {
...
## render a job (as a agentForm) and its children (hdas)
    <div class="agent agentForm">
        <%
            ...
            if agent:
                ...
                agent_name = "Unknown agent with id '%s'" % job.agent_id
                agent_desc = ''
        ...
        <div class="header">
            <div class="agentFormTitle">
                <span class="bold">${agent_name}</span>
                <span class="light">- ${agent_desc}</span>
                ##<a class="job-inputs-show" href="javascript:void(0)">${ _( "parameters" )}</a>
            </div>
            %if agent and params_object:
            <table class="job-inputs">
                ${ show_params.inputs_recursive( agent.inputs, params_object, depth=1 ) }
            </table>
            %else:
                <em>(${ _( 'No parameter data available' ) })</em>
            %endif
        </div>
        <div class="body agentFormBody">
...
## render a workflow and its children (jobs/agentForms)
    <div class="workflow">
        <div class="header">

...
<div class="tab-pane active agentForm" id="attributes">
    <div class="agentFormTitle">${_('Edit Attributes')}</div>
        ...
        <form name="edit_attributes" action="${h.url_for( controller='dataset', action='edit', dataset_id=dataset_id )}" method="post">
            ...
            %if trans.get_user() is not None:
                <div class="form-row">
                    ...
                    <div style="clear: both"></div>
                    <div class="agentParamHelp">Add an annotation or notes to a dataset; annotations are available when a history is viewed.</div>
                </div>
            %endif
...
<div class="tab-pane agentForm" id="convert">
    <div class="agentFormTitle">${_('Convert to new format')}</div>
    <div class="agentFormBody">
...
<div class="tab-pane agentForm" id="datatype">
    <div class="agentFormTitle">${_('Change data type')}</div>
    <div class="agentFormBody">
...
%elif trans.user:
    <div class="agentForm">
        <div class="agentFormTitle">View Permissions</div>
        <div class="agentFormBody">
            <div class="form-row">

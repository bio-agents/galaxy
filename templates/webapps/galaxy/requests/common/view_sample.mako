...
%if external_service:
    <p>
        <div class="agentForm">
            <div class="agentFormTitle">Available External Service Actions for ${sample.name | h} at ${external_service.name | h}</div>
...
<div class="agentForm">
    <div class="agentFormTitle">Sample "${sample.name | h}"</div>
    <div class="agentFormBody">
        <div class="form-row">
            <label>Name:</label>
            ${sample.name | h}

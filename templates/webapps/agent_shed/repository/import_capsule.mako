...
<div class="agentForm">
    <div class="agentFormTitle">Repository capsule information</div>
    <div class="agentFormBody">
        <div class="form-row">
        ...
        <div style="clear: both"></div>
        <div class="form-row">
            <label>Exported from Agent Shed:</label>
            ${export_info_dict.get( 'agent_shed', 'unknown' ) | h}
        </div>
        <div style="clear: both"></div>
        <div class="form-row">
        ...
        <div class="form-row">
            <div class="warningmessage">
                ...
                <p>
                    ...
                    that already exist in this Agent Shed.  These repositories will not be created, but the existing repository
                    will be used.  Existing repositories that are deprecated or deleted must be manually altered appropriately.
                </p>
                <p>
                    If you are not an admin user in this Agent Shed and you are not a member of the <b>Intergalactic Utilities
                    Commission</b> defined for this Agent Shed, you will only be able to import repository archives whose
                    ...
                    these repository archives in this Agent Shed if necessary.
                </p>
                <p>
                    Repositories that do not yet exist in this Agent Shed (and whose archives you are authorized to import) will
...
<div class="agentForm">
    <div class="agentFormTitle">Import capsule</div>

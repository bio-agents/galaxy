        ...
        <form id="upload_form" name="upload_form" action="${h.url_for( controller='upload', action='upload', repository_id=trans.security.encode_id( repository.id ) )}" enctype="multipart/form-data" method="post">
            ...
            <div class="form-row">
                ...
                <div class="agentParamHelp" style="clear: both;">
                     ...
                     to the Agent Shed repository as a single new changeset.  The revision history of the originating external mercurial repository is
                     not uploaded to the Agent Shed repository.
                </div>
                <div style="clear: both"></div>
            </div>
            <div class="form-row">

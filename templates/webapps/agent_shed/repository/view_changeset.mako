...
<%namespace file="/webapps/agent_shed/repository/common.mako" import="render_clone_str" />
...
${render_agent_shed_repository_actions( repository=repository, metadata=metadata )}
...
<div class="agentForm">
    <%
        from agent_shed.util.hg_util import get_readable_ctx_date

...
<%namespace file="/webapps/agent_shed/repository/common.mako" import="render_repository_type_select_field" />
...
<div class="agentForm">
    <div class="agentFormTitle">Create Repository</div>

...
<%
    from agent_shed.grids.util import build_approved_select_field
...
${render_agent_shed_repository_actions( repository=repository, changeset_revision=changeset_revision )}
...
<div class="agentForm">
    <div class="agentFormTitle">Revision reviews of repository '${repository.name | h}'</div>

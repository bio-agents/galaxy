...
<div class="agentForm">
    <div class="agentFormTitle">Email alerts for new repositories</div>
...
%if email_alert_repositories:
    <div class="agentForm">
        <div class="agentFormTitle">You are registered to receive email alerts for changes to the following repositories</div>
        <div class="form-row">
            <table class="grid">
                <tr>
                    <th>Name</th>

...
<div class="warningmessage">
    ...
    the agent shed paster log to pass the time if necessary.
</div>

<div class="agentForm">
    <div class="agentFormTitle">Reset all metadata on each selected repository</div>
        <%
            if trans.user_is_admin():
                controller = 'admin'
                action = 'reset_metadata_on_selected_repositories_in_agent_shed'
            else:
                controller = 'repository'
                action = 'reset_metadata_on_my_writable_repositories_in_agent_shed'
        %>

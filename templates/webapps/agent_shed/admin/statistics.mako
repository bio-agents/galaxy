...
<div class="agentForm">
    <div class="agentFormTitle">Agent shed statistics generated on ${trans.app.shed_counter.generation_time}</div>
        <form name="regenerate_statistics" id="regenerate_statistics" action="${h.url_for( controller='admin', action='regenerate_statistics' )}" method="post" >
            <div class="form-row">
                <table class="grid">
                    ...
                    <tr>
                        <td>Valid agents</td>
                        <td>${trans.app.shed_counter.unique_valid_agents | h}</td>
                    </tr>
                    <tr>
                        <td>Valid versions of agents</td>
                        <td>${trans.app.shed_counter.valid_versions_of_agents | h}</td>
                    </tr>
                    <tr>
                        <td>Invalid versions of agents</td>
                        <td>${trans.app.shed_counter.invalid_versions_of_agents | h}</td>
                    </tr>
                    <tr>

...
<%def name="render_user_info()">
    ...
    <div class="agentForm">
        <form name="login_info" id="login_info" action="${h.url_for( controller='user', action='edit_info', cntrller=cntrller, user_id=trans.security.encode_id( user.id ) )}" method="post" >
            <div class="agentFormTitle">Login Information</div>
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                %if t.webapp.name == 'agent_shed':
                    %if user.active_repositories:
                        <input type="hidden" id="name_input" name="username" value="${username | h}"/>
                        ${username | h}
                        <div class="agentParamHelp" style="clear: both;">
                            You cannot change your public name after you have created a repository in this agent shed.
                        </div>
                    %else:
                        <input type="text" id="name_input" name="username" size="40" value="${username | h}"/>
                        <div class="agentParamHelp" style="clear: both;">
                            Your public name provides a means of identifying you publicly within this agent shed. Public

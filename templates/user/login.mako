...
def inherit(context):
    ...
    elif context.get('trans').webapp.name == 'agent_shed' and context.get( 'use_panels', True ):
...
<%def name="render_login_form( form_action=None )">
    ...
    %endif
    <div class="agentForm">
        <div class="agentFormTitle">Login</div>
...
<%def name="render_openid_form( redirect, auto_associate, openid_providers )">
    <div class="agentForm">
        <div class="agentFormTitle">OpenID Login</div>

...
$(function(){
    ...
    $("[name=page_content]").wymeditor( {
        ...
        agentsItems: [
            ...
            {'name': 'Superscript', 'title': 'Superscript', 'css': 'wym_agents_superscript'},
            {'name': 'Subscript', 'title': 'Subscript', 'css': 'wym_agents_subscript'},
            {'name': 'InsertOrderedList', 'title': 'Ordered_List', 'css': 'wym_agents_ordered_list'},
            {'name': 'InsertUnorderedList', 'title': 'Unordered_List', 'css': 'wym_agents_unordered_list'},

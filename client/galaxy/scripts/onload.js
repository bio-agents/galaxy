...
$(document).ready( function() {
    ...
    // Agenttips
    if ( $.fn.agenttip ) {
        // Put agenttips below items in panel header so that they do not overlap masthead.
        $(".unified-panel-header [title]").agenttip( { placement: 'bottom' } );

        // default agenttip initialization, it will follow the data-placement tag for agenttip location

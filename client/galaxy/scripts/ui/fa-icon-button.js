...
//============================================================================
    ...
    var faIconButton = function( options ){
        options = options || {};
        options.agenttipConfig = options.agenttipConfig || { placement: 'bottom' };
        ...
        var $button = $( html ).agenttip( options.agenttipConfig );

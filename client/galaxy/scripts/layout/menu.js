...
var Collection = Backbone.Collection.extend({
    ...
    fetch: function( options ){
        ...
        this.add({
            ...
            title           : 'Workflow',
            url             : 'workflow',
            agenttip         : 'Chain agents into workflows',
        ...
        this.add({
            ...
            title           : 'Shared Data',
            url             : 'library/index',
            agenttip         : 'Access published resources',
            menu            : [{
        ...
        Galaxy.user.get( 'is_admin' ) && this.add({
            ...
            title           : 'Admin',
            url             : 'admin',
            agenttip         : 'Administer this Galaxy',
            cls             : 'admin-only'
        });
        ...
        var helpTab = {
            id              : 'help',
            title           : 'Help',
            agenttip         : 'Support, contact, and community hubs',
            menu            : [{
                    title   : 'Support',
        ...
        if ( !Galaxy.user.id ){
            var userTab = {
                ...
                title           : 'User',
                cls             : 'loggedout-only',
                agenttip         : 'Account registration or login',
                menu            : [{
                    title       : 'Login',
                    url         : 'user/login',
                    target      : 'galaxy_main'
            ...
            var userTab = {
                ...
                title           : 'User',
                cls             : 'loggedin-only',
                agenttip         : 'Account preferences and saved data',
                menu            : [{
...
var Tab = Backbone.View.extend({
    ...
    render: function() {
        ...
        this.$toggle.html( this.model.get( 'title' ) || '' )
                    ...
                    .attr( 'title', this.model.get( 'agenttip' ) )
                    .agenttip( 'destroy' );
        this.model.get( 'agenttip' ) && this.$toggle.agenttip( { placement: 'bottom' } );

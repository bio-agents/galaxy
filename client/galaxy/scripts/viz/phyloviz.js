...
var PhylovizLayoutBase =  Backbone.View.extend({
    ...
    /**
     *  Creates bootstrap agenttip for the visualization. Has to be called repeatedly due to newly generated
     *  enterNodes
     */
    addAgenttips : function (){
        $(".agenttip").remove();      //clean up agenttip, just in case its listeners are removed by d3
        $(".node")
            ...
            .agenttip({'placement':'top', 'trigger' : 'hover'});
...
var SettingsMenu = UserMenuBase.extend({
    ...
    resetToDefaults : function(){
        $(".agenttip").remove();      // just in case the agent tip was not removed
        var self = this;

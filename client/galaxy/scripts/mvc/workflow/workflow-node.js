define(['mvc/workflow/workflow-view-node'], function( NodeView ) {
    var Node = Backbone.Model.extend({
        ...
        make_active : function () {
            $(this.element).addClass( "agentForm-active" );
        },
        make_inactive : function () {
            ...
            // Remove active class
            $(element).removeClass( "agentForm-active" );
        },
        ...
        init_field_data : function ( data ) {
            ...
            this.agent_state = data.agent_state;
            this.agent_errors = data.agent_errors;
            this.agenttip = data.agenttip ? data.agenttip : "";
        ...
        update_field_data : function( data ) {
            ...
            node.nodeView.renderAgentErrors();
            // Update input rows
            ...
            // In general workflow editor assumes agent outputs don't change in # or
        ...
        error : function ( text ) {
            var b = $(this.element).find( ".agentFormBody" );
            b.find( "div" ).remove();

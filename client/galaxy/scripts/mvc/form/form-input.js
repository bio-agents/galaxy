        ...
        */
        _refresh: function() {
            ...
            if (!this.field.collapsed) {
                ...
                this.$preview.hide();
                this._agenttip(this.text_disable, this.cls_disable);
            } else {
                this.$field.hide();
                this.$preview.show();
                this._agenttip(this.text_enable, this.cls_enable);
            }

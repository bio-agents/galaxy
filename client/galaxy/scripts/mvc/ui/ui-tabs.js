...
var View = Backbone.View.extend({
    ...
    initialize : function(options) {
        ...
        if (this.options.onnew) {
            ...
            // add agenttip
            $tab_new.agenttip({title: 'Add a new tab', placement: 'bottom', container: self.$el});
            
            // link click event
            $tab_new.on('click', function(e) {
                $tab_new.agenttip('hide');
                self.options.onnew();
            });
        }
    },
    ...
    add: function(options) {
        ...
        if (options.ondel) {
            ...
            $del_icon.agenttip({title: 'Delete this tab', placement: 'bottom', container: self.$el});
            $del_icon.on('click', function() {
                $del_icon.agenttip('destroy');
                self.$el.find('.agenttip').remove();
                options.ondel();
                return false;
            });
        }

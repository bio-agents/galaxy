...
var IconButtonView = Backbone.View.extend({
    ...
    initialize : function(){
        ...
        this.model.attributes.agenttip_config = { placement : 'bottom' };
        this.model.bind( 'change', this.render, this );
    },

    render : function( ){
        // hide agenttip
        this.$el.agenttip( 'hide' );

        var new_elem = this.template( this.model.toJSON() );
        // configure agenttip
        new_elem.agenttip( this.model.get( 'agenttip_config' ));
...
var IconButtonMenuView = Backbone.View.extend({
    ...
    render: function(){
        ...
        this.collection.each(function(button){
            ...
            // configure agenttip
            if (button.attributes.agenttip_config){
                elt.agenttip(button.attributes.agenttip_config);
            }

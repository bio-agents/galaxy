...
define(['utils/utils'], function( Utils ) {
    ...
    */
    var ButtonBase = Backbone.View.extend({
        initialize: function( options ) {
            ...
            $( this.el ).agenttip( { title: options.agenttip, placement: 'bottom' } );
        },
    ...
    */
    ...
    /** The check button is used in the agent form and allows to distinguish between multiple states e.g. all, partially and nothing selected.
    */
    ...
    */
    var ButtonIcon = Backbone.View.extend({
        initialize : function( options ) {
            ...
            // add agenttip
            this.$button.agenttip( { title: options.agenttip, placement: 'bottom' } );
        },
    ...
    */
    var ButtonMenu = Backbone.View.extend({
        ...
        initialize: function ( options ) {
            ...
            // add agenttip
            $root.agenttip( { title: options.agenttip, placement: 'bottom' } );
        },

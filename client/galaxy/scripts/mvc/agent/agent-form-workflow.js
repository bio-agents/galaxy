/**
    This is the workflow agent form.
*/
define(['utils/utils', 'mvc/agent/agent-form-base'],
    function(Utils, AgentFormBase) {
    ...
    var View = AgentFormBase.extend({
        initialize: function(options) {
            ...
            if (!this.node) {
                Galaxy.emit.debug('agent-form-workflow::initialize()', 'Node not found in workflow.');
                return;
            }
            ...
            options = Utils.merge(options, {
                ...
                update          : function(data) {
                    ...
                    // module information for the agent to update the workflow
                    // state stored on the client with. User needs to save
                    // for this to take effect.
                    self.node.update_field_data(data);
                    self.errors(data && data.agent_model)
                }
            });
            ...
            // create final agent form
            AgentFormBase.prototype.initialize.call(this, options);
        },

...
return {
    ...
    requirements: function(options) {
        var requirements_message = 'This agent requires ';
        ...
        return requirements_message + '. Click <a target="_blank" href="https://wiki.galaxyproject.org/Agents/Requirements">here</a> for more information.';
    }
};

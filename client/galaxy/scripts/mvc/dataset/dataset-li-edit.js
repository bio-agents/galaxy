...
//TODO: move titleButtons into state renderers, remove state checks in the buttons
    ...
    _renderEditButton : function(){
        ...
        // disable if purged or deleted and explain why in the agenttip
        if( deleted || purged ){
    ...
    _renderDeleteButton : function(){
        ...
        return faIconButton({
                ...
                classes     : 'delete-btn',
                onclick     : function() {
                    // ...bler... agenttips being left behind in DOM (hover out never called on deletion)
    ...
    _renderRerunButton : function(){
        ...
        if( this.model.get( 'rerunnable' ) ){
            return faIconButton({
                ...
                onclick     : function( ev ) {
                    ev.preventDefault();
                    // create webpack split point in order to load the agent form async
                    // TODO: split not working (agent loads fine)
                    require([ 'mvc/agent/agent-form' ], function( AgentForm ){
                        var form = new AgentForm.View({ 'job_id' : creating_job });

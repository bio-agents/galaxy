...
/** @lends DatasetListItemView.prototype */{
    ...
    */
    ...
    render : function( speed ){
        //HACK: hover exit doesn't seem to be called on prev. agenttips when RE-rendering - so: no agenttip hide
        // handle that here by removing previous view's agenttips
        //this.$el.find("[title]").agenttip( "destroy" );

 ...
 * It contains the agent bar with controls.
 */
var LibraryAgentbarView = Backbone.View.extend({
  el: '#center',
  ...
  render: function(){
    ...
    this.$el.html(agentbar_template( { admin_user: is_admin, anon_user: is_anonym } ) );
    if ( is_admin ){
  ...
  /**
   * Renders the element that shows pages into its div within the agentbar.
   */
  ...
  templateAgentBar: function(){
    return _.template([
      '<div class="library_style_container">',
        '<div id="agentbar_form">',
          '<div id="library_agentbar">',
  ...
  templatePaginator: function(){
    ...
    '<span id="lib_page_size_prompt">',
      ' showing <a data-toggle="agenttip" data-placement="top" title="Click to change the number of libraries on page"><%- libraries_shown %></a> of <%- total_libraries_count %> libraries',
    '</span>'
    ].join(''));
  },
...
return {
  LibraryAgentbarView: LibraryAgentbarView
};

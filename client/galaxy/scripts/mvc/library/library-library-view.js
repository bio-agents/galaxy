...
var LibraryView = Backbone.View.extend({
  ...
  templateLibraryPermissions : function(){
    ...
    tmpl_array.push('  <div id="library_agentbar">');
    tmpl_array.push('   <a href="#"><button data-toggle="agenttip" data-placement="top" title="Go back to the list of Libraries" class="btn btn-default primary-button" type="button"><span class="fa fa-list"></span> Libraries</span></button></a>');
    tmpl_array.push('  </div>');

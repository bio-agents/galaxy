...
var FolderListView = Backbone.View.extend({
    ...
    paginate: function( options ){
        ...
        Galaxy.libraries.folderAgentbarView.renderPaginator( this.options );
     ...
     * to ensure that the folder agentbar will show proper options
    ...
    postRender: function(){
        ...
        Galaxy.libraries.folderAgentbarView.configureElements(fetched_metadata);

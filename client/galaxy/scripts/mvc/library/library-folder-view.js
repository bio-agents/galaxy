...
var FolderView = Backbone.View.extend({
  ...
  templateFolderPermissions : function(){
    ...
    tmpl_array.push('  <div id="library_agentbar">');
    tmpl_array.push('   <a href="#/folders/<%= folder.get("parent_id") %>"><button data-toggle="agenttip" data-placement="top" title="Go back to the parent folder" class="btn btn-default primary-button" type="button"><span class="fa fa-caret-left fa-lg"></span> Parent folder</span></button></a>');
    tmpl_array.push('  </div>');
    ...
    tmpl_array.push('<button data-toggle="agenttip" data-placement="top" title="Save modifications" class="btn btn-default agentbtn_save_permissions primary-button" type="button"><span class="fa fa-floppy-o"></span> Save</span></button>');

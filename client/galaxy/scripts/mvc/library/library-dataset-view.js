...
var LibraryDatasetView = Backbone.View.extend({
  ...
  events: {
    "click .agentbtn_modify_dataset"       :   "enableModification",
    "click .agentbtn_cancel_modifications" :   "render",
    "click .agentbtn-download-dataset"     :   "downloadDataset",
    "click .agentbtn-import-dataset"       :   "importIntoHistory",
    "click .agentbtn-share-dataset"        :   "shareDataset",
    ...
    "click .agentbtn_save_permissions"     :   "savePermissions",

    // missing features below
    "click .agentbtn_save_modifications"   :   "comingSoon",
 ...
 refreshUserHistoriesList: function(callback){
  ...
  templateDataset : function(){
    ...
    tmpl_array.push('  <div id="library_agentbar">');
    tmpl_array.push('   <button data-toggle="agenttip" data-placement="top" title="Download dataset" class="btn btn-default agentbtn-download-dataset primary-button" type="button"><span class="fa fa-download"></span> Download</span></button>');
    tmpl_array.push('   <button data-toggle="agenttip" data-placement="top" title="Import dataset into history" class="btn btn-default agentbtn-import-dataset primary-button" type="button"><span class="fa fa-book"></span> to History</span></button>');

    tmpl_array.push('   <% if (item.get("can_user_modify")) { %>');
    tmpl_array.push('   <button data-toggle="agenttip" data-placement="top" title="Modify library item" class="btn btn-default agentbtn_modify_dataset primary-button" type="button"><span class="fa fa-pencil"></span> Modify</span></button>');
    tmpl_array.push('   <% } %>');

    tmpl_array.push('   <% if (item.get("can_user_manage")) { %>');
    tmpl_array.push('   <a href="#folders/<%- item.get("folder_id") %>/datasets/<%- item.id %>/permissions"><button data-toggle="agenttip" data-placement="top" title="Manage permissions" class="btn btn-default agentbtn_change_permissions primary-button" type="button"><span class="fa fa-group"></span> Permissions</span></button></a>');
    // tmpl_array.push('   <button data-toggle="agenttip" data-placement="top" title="Share dataset" class="btn btn-default agentbtn-share-dataset primary-button" type="button"><span class="fa fa-share"></span> Share</span></button>');
    tmpl_array.push('   <% } %>');
    ...
    tmpl_array.push('  <button data-toggle="agenttip" data-placement="top" title="Copy to clipboard" class="btn btn-default btn-copy-link-to-clipboard primary-button" type="button"><span class="fa fa-clipboard"></span> To Clipboard</span></button> ');
    tmpl_array.push('  </div>');
    tmpl_array.push('<% } %>');
  ...
  templateVersion : function(){
    ...
    tmpl_array.push('  <div id="library_agentbar">');
    tmpl_array.push('   <a href="#folders/<%- item.get("folder_id") %>/datasets/<%- item.id %>"><button data-toggle="agenttip" data-placement="top" title="Go to latest dataset" class="btn btn-default primary-button" type="button"><span class="fa fa-caret-left fa-lg"></span> Latest dataset</span></button><a>');
    tmpl_array.push('  </div>');
  ...
  templateModifyDataset : function(){
    ...
    tmpl_array.push('  <div id="library_agentbar">');
    tmpl_array.push('   <button data-toggle="agenttip" data-placement="top" title="Cancel modifications" class="btn btn-default agentbtn_cancel_modifications primary-button" type="button"><span class="fa fa-times"></span> Cancel</span></button>');
    tmpl_array.push('   <button data-toggle="agenttip" data-placement="top" title="Save modifications" class="btn btn-default agentbtn_save_modifications primary-button" type="button"><span class="fa fa-floppy-o"></span> Save</span></button>');
  ...
  templateDatasetPermissions : function(){
    ...
    tmpl_array.push('  <div id="library_agentbar">');
    tmpl_array.push('   <a href="#folders/<%- item.get("folder_id") %>"><button data-toggle="agenttip" data-placement="top" title="Go back to containing folder" class="btn btn-default primary-button" type="button"><span class="fa fa-folder-open-o"></span> Containing Folder</span></button></a>');
    tmpl_array.push('   <a href="#folders/<%- item.get("folder_id") %>/datasets/<%- item.id %>"><button data-toggle="agenttip" data-placement="top" title="Go back to dataset" class="btn btn-default primary-button" type="button"><span class="fa fa-file-o"></span> Dataset Details</span></button><a>');
    ...
    tmpl_array.push(' <button data-toggle="agenttip" data-placement="top" title="Everybody will be able to access the dataset." class="btn btn-default btn-remove-restrictions primary-button" type="button">');
    tmpl_array.push(' <span class="fa fa-globe"> Remove restrictions</span>');
    tmpl_array.push(' </button>');
    tmpl_array.push(' </p>');
    tmpl_array.push('<% } else { %>');
    tmpl_array.push('  This dataset is unrestricted so everybody can access it. Just share the URL of this page.');
    tmpl_array.push('  <button data-toggle="agenttip" data-placement="top" title="Copy to clipboard" class="btn btn-default btn-copy-link-to-clipboard primary-button" type="button"><span class="fa fa-clipboard"> To Clipboard</span></button> ');
    tmpl_array.push('  <p>You can make this dataset private to you. ');
    tmpl_array.push(' <button data-toggle="agenttip" data-placement="top" title="Only you will be able to access the dataset." class="btn btn-default btn-make-private primary-button" type="button"><span class="fa fa-key"> Make Private</span></button>');
    tmpl_array.push(' </p>');
    // tmpl_array.push(' <p>You can share this dataset privately with other Galaxy users. ');
    // tmpl_array.push(' <button data-toggle="agenttip" data-placement="top" title="Only you and the suers you choose will be able to access the dataset." class="btn btn-default btn-share-dataset primary-button" type="button"><span class="fa fa-share"> Share Privately</span></button>');
    // tmpl_array.push(' </p>');
    tmpl_array.push('<% } %>');
    ...
    tmpl_array.push('<button data-toggle="agenttip" data-placement="top" title="Save modifications made on this page" class="btn btn-default agentbtn_save_permissions primary-button" type="button"><span class="fa fa-floppy-o"></span> Save</span></button>');

...
var FolderAgentbarView = Backbone.View.extend({
  el: '#center',

  events: {
    'click #agentbtn_create_folder'        : 'createFolderFromModal',
    'click #agentbtn_bulk_import'          : 'modalBulkImport',
    'click #include_deleted_datasets_chk' : 'checkIncludeDeleted',
    'click #agentbtn_show_libinfo'         : 'showLibInfo',
    'click #agentbtn_bulk_delete'          : 'deleteSelectedDatasets',
  ...
  render: function(options){
    ...
    var agentbar_template = this.templateAgentBar();
    ...
    this.$el.html(agentbar_template(template_defaults));
  },
  ...
  templateAgentBar: function(){
    ...
    tmpl_array.push('<div class="checkbox agentbar-item logged-dataset-manipulation" style="height: 20px; display:none;">');
    tmpl_array.push('<label>');
    tmpl_array.push('<input id="include_deleted_datasets_chk" type="checkbox"> include deleted </input>');
    tmpl_array.push('</label>');
    tmpl_array.push('</div>');
    tmpl_array.push('   <button style="display:none;" data-toggle="agenttip" data-placement="top" title="Create New Folder" id="agentbtn_create_folder" class="btn btn-default primary-button add-library-items" type="button"><span class="fa fa-plus"></span> <span class="fa fa-folder"></span></button>');
    ...
    tmpl_array.push('  <button data-toggle="agenttip" data-placement="top" title="Import selected datasets into history" id="agentbtn_bulk_import" class="primary-button dataset-manipulation" style="margin-left: 0.5em; display:none;" type="button"><span class="fa fa-book"></span> to History</button>');
    tmpl_array.push('   <div id="agentbtn_dl" class="btn-group dataset-manipulation" style="margin-left: 0.5em; display:none; ">');
    ...
    tmpl_array.push('     </ul>');
    tmpl_array.push('   </div>');
    tmpl_array.push('   <button data-toggle="agenttip" data-placement="top" title="Mark selected datasets deleted" id="agentbtn_bulk_delete" class="primary-button logged-dataset-manipulation" style="margin-left: 0.5em; display:none; " type="button"><span class="fa fa-times"></span> Delete</button>');
    tmpl_array.push('   <button data-id="<%- id %>" data-toggle="agenttip" data-placement="top" title="Show library information" id="agentbtn_show_libinfo" class="primary-button" style="margin-left: 0.5em;" type="button"><span class="fa fa-info-circle"></span> Library Info</button>');
    tmpl_array.push('   <span class="help-button" data-toggle="agenttip" data-placement="top" title="Visit Libraries Wiki"><a href="https://wiki.galaxyproject.org/DataLibraries/screen/FolderContents" target="_blank"><button class="primary-button" type="button"><span class="fa fa-question-circle"></span> Help</button></a></span>');
    tmpl_array.push(' </div>');
  ...
  templateLibInfoInModal: function(){
    ...
    tmpl_array.push('<p data-toggle="agenttip" data-placement="top" title="<%- library.get("create_time") %>">created <%- library.get("create_time_pretty") %></p>');
  ...
  templatePaginator: function(){
    ...
    tmpl_array.push('   </ul>');
    tmpl_array.push('   <span>');
    tmpl_array.push('       showing <a data-toggle="agenttip" data-placement="top" title="Click to change the number of items on page" id="page_size_prompt"><%- items_shown %></a> of <%- total_items_count %> items');
    tmpl_array.push('   </span>');
...
return {
    FolderAgentbarView: FolderAgentbarView
};

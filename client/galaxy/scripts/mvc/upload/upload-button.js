...
var Model = Backbone.Model.extend({
    defaults: {
        icon        : 'fa-upload',
        agenttip     : 'Download from URL or upload files from disk',
        label       : 'Load Data',
        percentage  : 0,
        status      : ''
    }
...
var View = Backbone.View.extend({
    ...
    initialize : function( options ) {
        ...
        // add agenttip
        this.$el.agenttip( { title: model.get('agenttip'), placement: 'bottom' } );
    ...
    _template: function() {
        return  '<div class="upload-button">' +
                    '<div class="progress">' +
                        ...
                        '<a class="panel-header-button" href="javascript:void(0)" id="agent-panel-upload-button">' +

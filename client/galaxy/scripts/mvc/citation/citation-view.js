    ...
    partialWarningElement: function() {
        if( this.collection.partial ) {
            return [
                ...
                '<b>Warning: This is a experimental feature.</b> Most Galaxy agents will not annotate',
    ...
    citationsElement: function() {
        return [
            '<div class="agentForm">',
                ...
                '</div>',
                '<div class="agentFormBody" style="padding:5px 10px">',
                this.partialWarningElement(),
                '<span class="citations-formatted" style="word-wrap: break-word;"></span>',
                '</div>',
                '<div class="citations-bibtex agentFormBody" style="padding:5px 10px">',

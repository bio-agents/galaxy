...
def __main__():
    ...
    # need to create SRMA dict and Samagents fai files for custom genome
    if options.fileSource == 'history':
        try:
            ...
            # create fai file using Samagents
            index_fai_cmd = 'samagents faidx %s' % reference_filepath_name
            try:
                ...
                stop_err( 'Error creating Samagents index for custom genome file: %s\n' % str( e ) )

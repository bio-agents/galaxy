...
def download_from_genomespace_importer( username, token, json_parameter_file, genomespace_site, gs_agentname ):
...
if __name__ == '__main__':
    ...
    download_from_genomespace_importer( options.username, options.token, options.json_parameter_file, options.genomespace_site, options.genomespace_agentname )

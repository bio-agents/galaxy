...
def download_from_genomespace_file_browser( json_parameter_file, genomespace_site, gs_agentname ):
...
if __name__ == '__main__':
    ...
    download_from_genomespace_file_browser( options.json_parameter_file, options.genomespace_site, options.genomespace_agentname )

...
def exec_before_job( app, inp_data, out_data, param_dict, agent=None):
...
def exec_after_process( app, inp_data, out_data, param_dict, agent=None, stdout=None, stderr=None):
    # in a perfect world, changes to param_dict would persist
    # for now, unlink from agent

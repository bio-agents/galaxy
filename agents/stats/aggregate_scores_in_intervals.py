...
from galaxy.agents.exception_handling import UCSCLimitException, UCSCOutWrapper
...
def main():
    ...
    if score_fname == 'None':
        stop_err( 'This agent works with data from genome builds hg16, hg17 or hg18.  Click the pencil icon in your history item to set the genome build if appropriate.' )

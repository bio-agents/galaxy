#!/usr/bin/env python
# This agent takes a tab-delimited text file as input and creates filters on columns based on certain properties.
...
try:
    ...
    stop_err( "Data does not appear to be tabular.  This agent can only be used with tab-delimited data." )
